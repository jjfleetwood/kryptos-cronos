...
# MIGRATION: Replace RSA/ECC with CRYSTALS-Kyber for key exchange`,
  ...
  {
    epochId: "quantum-1",
    wonder: { name: "Delft University Quantum Lab", location: "Delft, Netherlands", era: "2024 CE", emoji: "🔗" },
    id: "quantum-05",
    order: 5,
...
# Alice and Bob always agree — foundation of E91 QKD`,
      ...
      incident: {
        title: "China's Micius Satellite — World's First Quantum-Entangled Satellite Link",
        when: "2017–2020",
        where: "China — Beijing to Vienna intercontinental QKD link via Micius satellite",
        impact: "First intercontinental quantum-encrypted communication; 7600km entangled photon transmission",
        body: [
          "In 2017, China launched the Micius quantum satellite, demonstrating entanglement distribution over 1,200km. In 2020, Micius enabled the first intercontinental quantum-encrypted video conference between Beijing and Vienna (7,600km), using satellite-relayed quantum key distribution. This demonstrated that quantum-secured communications are operationally feasible at global scale.",
          "China's quantum satellite program represents a significant strategic advantage: they can establish QKD links between diplomatic and military facilities using physics-based security guarantees. The US has begun similar programs. Quantum networking infrastructure is becoming a national security priority.",
        ],
      },
      diagram: {
        nodes: [
          { label: "Alice (qubit 0)", sub: "measures — gets 0 or 1", type: "system" },
          { label: "Entangled Bell Pair", sub: "|Φ+⟩ = (|00⟩+|11⟩)/√2", type: "attacker" },
          { label: "Bob (qubit 1)", sub: "instantly knows Alice's result", type: "victim" },
          { label: "Shared Secret Key", sub: "E91 QKD — eavesdrop-detectable", type: "result" },
        ],
      },
      timeline: [
        { year: 1935, event: "Einstein-Podolsky-Rosen paradox — 'spooky action at a distance' described" },
        { year: 1964, event: "John Bell derives Bell inequalities — test for entanglement vs hidden variables" },
        { year: 1991, event: "Artur Ekert proposes E91 QKD protocol based on entanglement" },
        { year: 2017, event: "China's Micius satellite — 1200km entanglement distribution", highlight: true },
        { year: 2020, event: "First intercontinental quantum-encrypted video conference via Micius" },
      ],
      keyTakeaways: [
        ...
        "China's Micius satellite demonstrated operational QKD at 7,600km — global quantum networking is imminent",
        "Quantum networks will extend QKD range using quantum repeaters based on entanglement swapping",
      ],
      references: [
        { title: "Science: Satellite-Based Entanglement Distribution (Micius)", url: "https://www.science.org/doi/10.1126/science.aan3211" },
    ...
    ctf: {
      scenario: "You're configuring a quantum-secured communications link using E91 entanglement-based QKD. Simulate the entanglement, verify Bell state correlations, and generate the shared secret key.",
      hint: "Create a Bell state, measure both qubits repeatedly to verify entanglement, then use the correlated measurements as a key.",
      hints: [
        "Read the QKD protocol brief. Run: cat e91-brief.txt",
        "Simulate the Bell pair generation and measure it 100 times. Run: bell-sim 100",
        "Run the E91 key generation using the entanglement correlations. Run: e91-keygen",
        "Run 'assemble' to view the assembled flag and get the submit command",
      ],
      flag: "FLAG{ENTANGL3D_B3LL_E91_QKD_K3Y}",
      fragments: [
        { trigger: "/e91-brief.txt", value: "FLAG{ENTANGL3D_", label: "E91 Brief — Entanglement-Based QKD Protocol" },
        { trigger: "bell-sim 100", value: "B3LL_E91_", label: "Bell State Verified — Only |00⟩ and |11⟩ Observed" },
        { trigger: "e91-keygen", value: "QKD_K3Y}", label: "Shared Key Generated — Information-Theoretically Secure" },
      ],
      files: {
        "/e91-brief.txt": [
          "E91 QKD PROTOCOL BRIEF",
          "Method: entangled Bell pairs distributed to Alice and Bob",
          "Security: any eavesdropper disturbs Bell inequalities — detectable",
          "",
          "Goal: generate a shared secret key from entanglement correlations.",
      ...
      extraCommands: {
        "bell-sim": (_args: string[]) => ({
          lines: [
            "Generating 100 entangled Bell pairs (|Φ+⟩)...",
            "Measuring all pairs in Z basis:",
            "  |00⟩: 52 times",
            "  |11⟩: 48 times",
            "  |01⟩: 0 times (never — entanglement confirmed)",
            "  |10⟩: 0 times (never — entanglement confirmed)",
            "Bell inequality violation confirmed — true quantum entanglement.",
          ],
        }),
        "e91-keygen": (_args: string[]) => ({
          lines: [
            "Running E91 key extraction from 100 entangled pairs...",
            "Sifting: 68 pairs used after basis reconciliation",
            "Error rate: 1.5% (below 11% threshold — no eavesdropper)",
            "Privacy amplification applied — final key: 512 bits",
            "Shared key: a3f2...b8c1 (information-theoretically secure)",
            "Fragment collected.",
          ],
        }),
      },

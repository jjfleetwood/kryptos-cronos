export const epochAccent: Record<string, { tab: string; active: string; bar: string }> = {
  ...
  "quantum-4":    { tab: "text-emerald-400 border-emerald-400 bg-emerald-400/10", active: "border-emerald-400/60 bg-emerald-500/5", bar: "bg-emerald-500" },
...
export const cardBorder: Record<string, string> = {
  ...
  "quantum-4":    "border-emerald-500/40 hover:border-emerald-400/80",
...
export const cardEmojiBg: Record<string, string> = {
  ...
  "quantum-4":    "from-emerald-950 to-slate-950",

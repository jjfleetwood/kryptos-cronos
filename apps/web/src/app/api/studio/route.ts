...
// admins), or to anyone holding the secret ?s=<share-token> link. Not public:
// free/anonymous callers without the link get 401/403 so the prose never leaves
// the server for non-Pro users. The /studio page renders what this returns.

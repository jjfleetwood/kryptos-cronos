...
export const epochGroups: TrackGroup[] = [
  ...
  { id: "cyberRange", labelKey: "stages.tracks.cyberRange", descKey: "stages.tracks.cyberRangeDesc", epochIds: ["range-metasploit", "range-recon", "range-web", "range-passwords", "range-privesc", "range-traffic", "range-ad", "range-wireless", "range-capstone"] },
];

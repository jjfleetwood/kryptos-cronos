      ...
      <div className="max-w-4xl mx-auto px-4 py-14">
        ...
        {state === "loading" ? (
          ...
          <div className="grid gap-5 sm:grid-cols-3">
            <Card href="/studio/prose" icon="📖" sub="Novel" title="The Novel" blurb="177 chapters of full prose — plus the chaptered narrated audiobook with a one-file .m4b download." />

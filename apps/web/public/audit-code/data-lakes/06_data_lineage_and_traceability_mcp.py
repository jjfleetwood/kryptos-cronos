...
never changes state — the hard requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 06_data_lineage_and_traceability_mcp.py                 # expose to an agent
  python 06_data_lineage_and_traceability_mcp.py --selftest       # reproduce findings against fixtures, offline
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Data lineage and traceability" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("DLW Data lineage and traceability Audit (read-only)")

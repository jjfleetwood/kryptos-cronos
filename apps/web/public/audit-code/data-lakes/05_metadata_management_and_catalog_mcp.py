#!/usr/bin/env python3
"""Read-only MCP server — Data Lakes & Warehouses: "Metadata management and catalog" audit evidence.
...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 05_metadata_management_and_catalog_mcp.py                 # expose to an agent
  python 05_metadata_management_and_catalog_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Metadata management and catalog" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("DLW Metadata management and catalog Audit (read-only)")

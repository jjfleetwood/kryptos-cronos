...
never changes state — the hard requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 04_data_quality_management_mcp.py                 # expose to an agent
  python 04_data_quality_management_mcp.py --selftest       # reproduce findings against fixtures, offline
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Data quality management" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("DLW Data quality management Audit (read-only)")

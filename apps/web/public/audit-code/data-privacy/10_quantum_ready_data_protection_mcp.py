...
never changes state — the hard requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 10_quantum_ready_data_protection_mcp.py                 # expose to an agent
  python 10_quantum_ready_data_protection_mcp.py --selftest       # reproduce findings against fixtures, offline
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Quantum-ready data protection" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("DPP Quantum-ready data protection Audit (read-only)")

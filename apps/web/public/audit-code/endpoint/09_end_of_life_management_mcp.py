...
never changes state — the hard requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 09_end_of_life_management_mcp.py                 # expose to an agent
  python 09_end_of_life_management_mcp.py --selftest       # reproduce findings against fixtures, offline
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "End-of-life management" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("EPT End-of-life management Audit (read-only)")

...
never changes state — the hard requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 18_exception_management_mcp.py                 # expose to an agent
  python 18_exception_management_mcp.py --selftest       # reproduce findings against fixtures, offline
...
def _register():
    ...
    mcp = FastMCP("EPT Exception management Audit (read-only)")

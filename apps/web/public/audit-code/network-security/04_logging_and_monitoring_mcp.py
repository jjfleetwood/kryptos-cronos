...
never changes state — the hard requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 04_logging_and_monitoring_mcp.py                 # expose to an agent
  python 04_logging_and_monitoring_mcp.py --selftest       # reproduce findings against fixtures, offline
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Logging and monitoring" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("NET Logging and monitoring Audit (read-only)")

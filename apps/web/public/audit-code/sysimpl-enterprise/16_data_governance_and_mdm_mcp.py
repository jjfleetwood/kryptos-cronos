...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 16_data_governance_and_mdm_mcp.py                 # expose to an agent
  python 16_data_governance_and_mdm_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Data governance and MDM" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("SIE Data governance and MDM Audit (read-only)")

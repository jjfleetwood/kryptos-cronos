...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 20_infra_and_capacity_planning_mcp.py                 # expose to an agent
  python 20_infra_and_capacity_planning_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Infra and capacity planning" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("SIE Infra and capacity planning Audit (read-only)")

...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 04_testing_qa_e2e_mcp.py                 # expose to an agent
  python 04_testing_qa_e2e_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Testing & QA (E2E)" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("SIE Testing & QA (E2E) Audit (read-only)")

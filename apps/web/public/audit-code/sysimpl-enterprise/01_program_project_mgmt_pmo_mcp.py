...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 01_program_project_mgmt_pmo_mcp.py                 # expose to an agent
  python 01_program_project_mgmt_pmo_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Program & project mgmt (PMO)" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("SIE Program & project mgmt (PMO) Audit (read-only)")

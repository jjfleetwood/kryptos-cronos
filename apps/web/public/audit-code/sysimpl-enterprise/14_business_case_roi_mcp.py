...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 14_business_case_roi_mcp.py                 # expose to an agent
  python 14_business_case_roi_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Business case, ROI" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("SIE Business case, ROI Audit (read-only)")

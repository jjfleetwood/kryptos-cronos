...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 08_post_implementation_support_hypercare_mcp.py                 # expose to an agent
  python 08_post_implementation_support_hypercare_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Post-implementation support / hypercare" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("SIE Post-implementation support / hypercare Audit (read-only)")

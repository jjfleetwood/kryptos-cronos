...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 02_enterprise_architecture_mcp.py                 # expose to an agent
  python 02_enterprise_architecture_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Enterprise architecture" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("SIE Enterprise architecture Audit (read-only)")

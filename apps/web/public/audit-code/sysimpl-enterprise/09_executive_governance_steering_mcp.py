...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 09_executive_governance_steering_mcp.py                 # expose to an agent
  python 09_executive_governance_steering_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Executive governance / steering" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("SIE Executive governance / steering Audit (read-only)")

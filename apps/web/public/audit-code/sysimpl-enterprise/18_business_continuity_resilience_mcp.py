...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 18_business_continuity_resilience_mcp.py                 # expose to an agent
  python 18_business_continuity_resilience_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Business continuity / resilience" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("SIE Business continuity / resilience Audit (read-only)")

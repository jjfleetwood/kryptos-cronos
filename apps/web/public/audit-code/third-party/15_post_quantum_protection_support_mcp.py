...
never changes state — the hard requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 15_post_quantum_protection_support_mcp.py                 # expose to an agent
  python 15_post_quantum_protection_support_mcp.py --selftest       # reproduce findings against fixtures, offline
...
def _register():
    ...
    mcp = FastMCP("TPS Post-quantum protection support Audit (read-only)")

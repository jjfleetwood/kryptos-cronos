#!/usr/bin/env python3
"""Read-only MCP server — Internet of Things (IoT): "Lightweight cryptography" audit evidence.
...
REAL SOURCES / COMMANDS to wire in place of the fixtures (read-only):
    device cryptography appropriate to the hardware (strong, not homegrown/weak)

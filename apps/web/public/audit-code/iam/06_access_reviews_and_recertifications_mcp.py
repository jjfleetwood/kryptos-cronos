...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Access reviews and recertifications" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("IAM Access reviews and recertifications Audit (read-only)")

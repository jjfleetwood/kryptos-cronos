#!/usr/bin/env python3
"""Read-only MCP server — Change, Release & Configuration Management: "Configuration management" audit evidence.
...
REAL SOURCES / COMMANDS to wire in place of the fixtures (read-only):
    CMDB accuracy: CIs vs discovery-tool reconciliation (drift %)

...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 02_authentication_and_authorization_design_mcp.py                 # expose to an agent
  python 02_authentication_and_authorization_design_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Authentication and authorization design" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("AAR Authentication and authorization design Audit (read-only)")

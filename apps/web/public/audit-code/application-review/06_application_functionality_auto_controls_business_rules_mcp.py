...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 06_application_functionality_auto_controls_business_rules_mcp.py                 # expose to an agent
  python 06_application_functionality_auto_controls_business_rules_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Application functionality (auto controls, business rules)" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("AAR Application functionality (auto controls, business rules) Audit (read-only)")

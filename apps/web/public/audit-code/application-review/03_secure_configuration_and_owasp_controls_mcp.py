...
def build_inventory() -> list[dict]:
    """List every in-scope item the "Secure configuration and OWASP controls" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("AAR Secure configuration and OWASP controls Audit (read-only)")

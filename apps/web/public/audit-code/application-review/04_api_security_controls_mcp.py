...
requirement for audit tooling.
  ...
  pip install "mcp[cli]"
  mcp run 04_api_security_controls_mcp.py                 # expose to an agent
  python 04_api_security_controls_mcp.py --selftest       # reproduce findings against fixtures, offline
"""
...
def build_inventory() -> list[dict]:
    """List every in-scope item the "API security controls" control must cover."""
...
def _register():
    ...
    mcp = FastMCP("AAR API security controls Audit (read-only)")

#!/usr/bin/env python3
"""Read-only MCP server — Build Env / CI/CD: "AI-assisted dev / agentic workloads" audit evidence.
...
GitHub Actions / GitLab CI / Jenkins, Container registry (ECR/GHCR), Kubernetes / orchestration, Artifact + SBOM store.
"""

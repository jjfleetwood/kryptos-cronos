#!/usr/bin/env python3
"""Read-only MCP server — Secure Software Development: "Container and cloud-native security" audit evidence.
...
REAL SOURCES / COMMANDS to wire in place of the fixtures (read-only):
    build-time Trivy/Grype scan + dockle (root, secrets, healthcheck)

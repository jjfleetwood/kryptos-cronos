...
**Web version:** v1.25.0 · **Mobile app:** in development (Expo, pre-store)
...
| [CURRICULUM.md](CURRICULUM.md) | Full stage catalog across all 38 epochs |
...
- **Curriculum:** 458 stages · 38 epochs · 10 tracks. Every CTF stage is dual-mode (Quiz + CTF). 10 cert paths on `/certs` (Security+, CySA+, Network+, ISC² CC, CompTIA AI+, ISACA CISA/CISM/CRISC, AWS AI Practitioner, Google Cloud PMLE) + a CyberOps Associate tracker.

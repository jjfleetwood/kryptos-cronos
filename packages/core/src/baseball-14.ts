...
export const baseball14Stages: StageConfig[] = [
  // ─── baseball-14-01: The Captain of the Outfield ──────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The center fielder is the captain of the outfield and has priority on any ball he can reach. When a ball is hit into a gap, the center fielder calls off the corner outfielder if he can get to it, because his angle and speed usually make him the better play and the priority prevents collisions. The center fielder also:\n- Positions the corner outfielders.\n- Communicates on every ball.\n- Leads the outfield the way the shortstop leads the infield.\nHis combination of range, leadership, and priority makes him the hub of outfield defense.",
        "The center fielder's signature plays are among the most spectacular in baseball:\n- Running down balls in the gaps.\n- The over-the-shoulder catch on deep drives.\n- Robbing home runs by leaping at the wall. Ken Griffey Jr. patrolled center field with a grace that made the impossible look routine, robbing home runs and covering ground effortlessly. This epoch builds the complete center fielder: the elite range and reads to cover the most ground, the arm to throw, and the leadership to captain the outfield.",
      ],
      technical: {
  ...
  // ─── baseball-14-02: Reading the Ball and the Jump ────────────────────────────
  {
    ...
    info: {
      ...
      year: 1990,
      overview: [
        "Reading the ball off the bat and getting a great jump matters even more for the center fielder than the corners, because he covers the most ground and must break in any direction. From straightaway, he reads balls hit:\n- To either gap.\n- Directly over his head.\n- In front of him.\nHis read and first step must work in every direction — a great jump covers his vast territory; a poor one leaves gap balls dropping that he should have reached.",
        "The read begins before contact, with anticipation — the center fielder studies the pitch, count, and hitter's tendencies and may shade toward a gap. At contact, he reads trajectory from the sound and initial flight, then takes the proper first step:\n- A drop step and turn on balls over his head (never backpedaling).\n- A hard break to the gap.\n- A controlled charge on balls in front.\nBecause he must read balls to both sides, his reads have to be accurate in every direction.",
  ...
  // ─── baseball-14-03: Catching and Robbing Home Runs ───────────────────────────
  {
    ...
    info: {
      ...
      year: 1990,
      overview: [
        "The center fielder makes the full range of outfield catches:\n- Routine flies and line drives.\n- Over-the-shoulder catches on deep balls.\n- The most spectacular play in the outfield — robbing a home run by leaping at the wall.\nThe fundamentals match any outfielder (good route, get under control, two hands above the throwing shoulder), but his range means more deep, running catches and wall plays than anyone — so the over-the-shoulder catch and the leap at the wall are signature skills.",
        ...
        "Robbing a home run is the center fielder's signature play, and it's a precise sequence:\n- Read the ball off the bat as one that will clear the fence.\n- Sprint to the wall.\n- Locate the wall to time the jump safely.\n- Leap at the right moment to catch the ball above the fence.\nKen Griffey Jr. and Andruw Jones made home-run robbery a hallmark of elite center-field defense — it combines read, route, speed, and timing in one spectacular play.",
      ],
      technical: {
  ...
  // ─── baseball-14-04: Route Running and the Gaps ───────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The center fielder reads trajectory and takes the angle that intercepts the ball at its landing spot:\n- On a ball to the gap — a route that accounts for the ball's curve and lets him arrive moving toward the infield for the throw.\n- On a deep ball — the most direct angle to the spot for an over-the-shoulder catch.\nThe 'banana' route — a slightly curved path — gets him to the catch point with momentum toward the target, rather than a straight line that leaves him moving away from the play.",
        "Covering the gaps is the center fielder's defining range responsibility, shared with the corner outfielders:\n- He has priority and usually takes balls in the gap he can reach, calling off the corner outfielder.\n- Efficient routes let him erase the gaps — turning would-be doubles and triples into outs.\nBecause he covers the most ground, his route running has the biggest impact on a team's outfield defense. Mastering efficient routes in every direction is what lets him cover his enormous territory.",
      ],
      technical: {
  ...
  // ─── baseball-14-05: Building the Center Fielder's Body ───────────────────────
  {
    ...
    info: {
      ...
      year: 2015,
      overview: [
        "Center field demands the most athletic body in the outfield, because the center fielder covers the most ground. The key physical priorities:\n- Elite top-end straight-line speed — to run down deep balls and reach the gaps.\n- Explosive first-step quickness and acceleration — for a great jump and breaking in any direction.\n- Change-of-direction agility — to handle balls to both sides and adjust routes.\n- Endurance — to cover the most ground and stay sharp through a long game and season.\n- A strong, accurate arm.\nHe's typically the fastest, most athletic outfielder.",
        "Speed and acceleration are the foundation:\n- Elite straight-line speed lets him run down deep drives over a vast area.\n- Explosive first-step quickness and acceleration produce the great jump and the break in any direction.\n- Change-of-direction agility handles balls to both gaps and route adjustments.\nThese are built through sprint training, acceleration and reaction drills, and agility work; strong legs and a powerful core drive the sprint and the throws.",
  ...
  // ─── baseball-14-06: The Throw and Long Throws ────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1995,
      overview: [
        "The center fielder makes the longest throws in the outfield because he plays the deepest, so a strong, accurate arm and sound mechanics are essential. The same principles apply as for any outfielder:\n- The crow-hop to generate a strong throw.\n- A four-seam grip and a low, carrying trajectory.\n- Hitting the cutoff man.\nBut his throws — to third base, home plate, and second base — are often the longest and most important, which makes the relay system especially valuable on deep balls.",
        "The crow-hop and a low trajectory generate the long throws:\n- After fielding or catching, take a crow-hop to gather momentum.\n- Throw over the top with a four-seam grip on a low, carrying line — not a high rainbow that loses speed and sails over the cutoff man.\nFrom deep center, a low, strong throw on a line gets there faster and stays catchable for the cutoff man. Arm strength plus good footwork and a low trajectory is what lets him make the throws his position requires.",
  ...
  // ─── baseball-14-07: Priority, Calling Off, and Communication ─────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The outfield priority order is clear:\n- The center fielder has priority over both corner outfielders.\n- An outfielder generally has priority over an infielder on a ball both can reach (the outfielder is moving in with a better angle).\nWhen the center fielder calls for a ball, the corner outfielder defers immediately and backs up the play. He must call early and loudly enough to be heard over the crowd — and yield clearly when a corner outfielder has the better play.",
        "Communication extends well beyond calling for catches. The center fielder:\n- Positions the corner outfielders.\n- Relays the situation.\n- Communicates on relays and cutoffs.\n- Coordinates the outfield's response to every ball.\nAs the captain, he leads the outfield the way the shortstop leads the infield. Clear, constant communication is what makes the outfield a coordinated unit and prevents the collisions and dropped balls that miscommunication causes.",
      ],
      technical: {
  ...
  // ─── baseball-14-08: Backing Up the Middle ────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The center fielder also backs up plays he can't catch but can get behind:\n- The corner outfielders on balls to the gap or down the line that they take.\n- Balls hit through the infield up the middle.\nThe principle, as for all outfielders, is that an overthrow or misplayed ball in his area should never go unguarded — he positions behind the play so a misplay doesn't cost extra bases.",
        "Knowing his backup responsibilities and reacting instantly is part of the job on every pitch:\n- Backing up second base on a steal.\n- Backing up the corner outfielders on balls in the gaps and down the lines.\n- Backing up balls hit up the middle.\nThese constant, unglamorous responsibilities prevent extra bases on misplays. Combined with his catching, throwing, and leadership, they make the center fielder a contributor on every play — he's never standing still.",
      ],
      technical: {
  ...
  // ─── baseball-14-09: Situational IQ ───────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2000,
      overview: [
        "As the captain of the outfield, the center fielder processes the situation for himself and the whole unit before each pitch. The key reads:\n- Score, inning, outs.\n- Runners and their speed.\n- The count and the hitter's tendencies.\nHe sets his own depth and position, helps position the corner outfielders, and pre-decides where the play is and where he'll throw. Because he's leading, his thinking covers the whole outfield, not just his own play.",
        "Positioning decisions flow from the situation:\n- Deep in no-doubles situations (late in close games) to prevent extra-base hits over his head.\n- Shallower when a play at the plate is likely.\n- Shaded toward a gap based on the hitter's tendencies — moving the whole outfield to the pull side against a pull hitter.\nHe also accounts for the elements — the sun, the wind, and the field's quirks — checking them before each at-bat and leading the outfield's adjustments.",
  ...
  // ─── baseball-14-10: The Greats and Mastery ───────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2016,
      overview: [
        "The greatest center fielders share a set of pursuable traits:\n- A great jump and efficient routes built on elite reads.\n- The speed and range to cover the most ground.\n- Sure hands and the ability to make over-the-shoulder catches and rob home runs.\n- A strong, accurate arm for the long throws.\n- Priority and leadership to captain the outfield.\n- The situational intelligence to position the whole unit and pre-decide throws.\nKen Griffey Jr., Willie Mays, and Andruw Jones embodied all of it with grace — but the qualities, not the highlights, are what to build.",

...
export const baseball6Stages: StageConfig[] = [
  // ─── baseball-6-01: Four-Seam Fastball ────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Velocity benchmarks vary by age:\n- A dominant 12-year-old four-seamer sits 60–68 mph.\n- By 14, elite arms reach 70–78 mph.\n- High school varsity starters average 78–85 mph.\n- College starters average 86–91 mph.\n- MLB average is 93–94 mph, with elite power pitchers reaching 99–103 mph.\nFor Dodger starters, the four-seamer is the pitch that establishes presence: Yoshinobu Yamamoto, Tyler Glasnow, and Walker Buehler all throw four-seamers at the top of the zone early in counts to get ahead and make hitters respect velocity.",
      ],
      technical: {
  ...
  // ─── baseball-6-02: Two-Seam Fastball and Sinker ─────────────────────────────
  {
    ...
    info: {
      ...
      year: 2015,
      overview: [
        "The two-seam fastball grips the ball along (not across) the narrow seam gap — the two seams that run parallel on one side:\n- Index and middle fingers sit on or just inside the two narrow seams.\n- The thumb rests underneath.\n- The altered seam orientation adds sidespin alongside backspin.\nThe result tails to the pitcher's arm side (down and in on a same-handed hitter) and drops more than a four-seamer.",
        "The sinker is a close relative — sometimes a two-seam variant, sometimes taught as its own pitch:\n- Both share the tailing, sinking action.\n- The sinker adds slightly more deliberate downward pressure at release, trading pure velocity for more sink.\nThrown to the lower half of the zone, it's the ground-ball machine of pitching — weak contact on the top of the ball, producing rolling grounders to infielders.",
  ...
  // ─── baseball-6-03: The Changeup ─────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Three primary changeup grips produce slightly different movement:\n- Circle change (most common) — thumb and index finger form a circle on the side, three fingers across the top; cuts velocity via drag while keeping arm speed.\n- Palmball — ball held deep in the palm, all fingers wrapped; more velocity reduction, but harder to throw without telegraphing.\n- Vulcan change — split the middle and ring fingers around the ball's equator for a tumbling action with late fade.",
        "Speed differential is the key measurement — a 10–15 mph gap from the fastball is optimal (enough to disrupt timing, not so much the hitter reads it early):\n- A youth pitcher at 72 mph wants a changeup at 58–62 mph.\n- An MLB starter at 94 mph targets 80–84 mph.\nKenley Jansen, the Dodgers' longtime closer, mixed his elite cutter with a changeup specifically to keep left-handed hitters off-balance after building a career on the cutter alone.",
      ],
      technical: {
  ...
  // ─── baseball-6-04: The Curveball ────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Curveballs come in a few shapes, named for the clock face:\n- 12-to-6 — drops straight down, the ideal high-to-low plane from belt to knees or dirt.\n- 11-to-5 (or 10-to-4) — adds lateral movement, sweeping away from same-side hitters while dropping.\n- Knuckle curve — the index finger's knuckle rests on the seam (not the fingertip), producing tighter topspin and a sharper, later break.",
        "Youth pitchers should wait until roughly age 13–14 to throw curveballs regularly — when the elbow's growth plates approach closure:\n- ASMI research led by Dr. James Andrews links early curveballs (before age 13) to significantly higher rates of elbow injury later in the career.\n- Clayton Kershaw's 'El Diablo' 12-6 hammer is the benchmark — same arm speed and release point as his fastball, dropping up to 20 inches vertically from release to plate.\nThe lesson: build the arm first, add the hook when the body is ready.",
      ],
      technical: {
  ...
  // ─── baseball-6-05: The Slider ────────────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2014,
      overview: [
        "The slider is baseball's second-most-common pitch and one of its best swing-and-miss weapons:\n- Velocity sits between the fastball (90–95) and curveball (75–82), typically 82–90 mph.\n- The grip places the index and middle fingers off-center on one side of the ball.\n- That produces mostly gyro (bullet) spin plus some sidespin — a tight, late lateral break, not the gradual sweep of a curveball.\nIt breaks away from same-side hitters late enough to be very hard to track.",
        "The cutter and the sweeper sit at opposite ends of the slider spectrum:\n- Cut slider ('cutter', covered next) — thrown harder, near fastball velocity, with shorter lateral break; it jams hitters.\n- Sweep slider — maximum lateral break (sometimes 18–22 inches of horizontal movement) at the cost of some velocity; it misses bats off the outside edge.\nBoth are called 'sliders,' but their intended outcomes differ.",
  ...
  // ─── baseball-6-06: The Cutter ────────────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1997,
      overview: [
        "The cut fastball (cutter) occupies a unique space in the arsenal:\n- Thrown at fastball velocity (88–96 mph) but gripped off-center.\n- Produces a small, sharp late break (2–5 inches) toward the pitcher's glove side.\n- Faster than a slider but with less break, off the same arm speed and release as a four-seamer.\nIt looks exactly like a fastball until the last few feet, when it cuts sharply.",
        "Mariano Rivera's cutter is the most famous single pitch in baseball history — 93–95 mph with remarkable consistency, breaking 4–5 inches to his glove side at the last moment:\n- Against left-handed hitters it ran in toward their hands, sawing off countless bat handles over 19 seasons.\n- Against right-handed hitters it moved away from their barrels.\nBatters reported preparing exclusively for it and still couldn't hit it — he saved 652 games on essentially one pitch.",
  ...
  // ─── baseball-6-07: Splitter and Forkball ────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1995,
      overview: [
        "The split-fingered fastball (splitter) and forkball are the most dramatic of the 'fastball family' pitches:\n- Gripped with the fingers spread wide on either side of the ball.\n- That reduces velocity, eliminates backspin, and creates a tumbling action.\n- The ball dives sharply downward in the final feet before the plate.\nTo the hitter it looks like a fastball — same arm speed, similar initial path — until it drops out of the zone, producing swings over the top or checked swings into the dirt.",
        "The splitter and forkball differ mainly in how deep the fingers sit:\n- Splitter — index and middle fingers spread along the seam on either side, not forced to the knuckles (a middle-deep grip).\n- Forkball — fingers forced further apart and deeper, between the knuckles; more extreme velocity loss (often 15–20 mph below fastball) and more dramatic dive, at the cost of command and arm stress.\nBoth generate forward tumbling spin — the opposite of backspin — which adds to gravity for the late-break dive.",
  ...
  // ─── baseball-6-08: Spin Rate, Spin Axis, and Rapsodo ────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Statcast (2015) and Rapsodo (a portable launch monitor now in high-school and college programs) measure three key spin variables:\n- Total spin rate (rpm) — how fast the ball rotates.\n- Spin axis — expressed as a clock-face angle (12:00 = pure backspin, 6:00 = pure topspin).\n- Spin efficiency — the percentage of total spin that actually contributes to movement.\nTogether these three numbers explain exactly why a pitch moves the way it does.",
  ...
  // ─── baseball-6-09: Pitch Tunneling and Deception ────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "A pitcher with excellent tunneling throws every pitch the same way out of the hand:\n- Same release point.\n- Same arm angle.\n- Same initial trajectory — fastball, curveball, slider, or changeup all leave on the same path.\nThe divergence — where physics splits each pitch's movement — happens as late as possible. A short tunnel (early divergence) gives the hitter more time to identify and adjust; a long tunnel (shared path further) leaves less.",
  ...
  // ─── baseball-6-10: Building Your Arsenal by Age ─────────────────────────────
  {
    ...
    info: {
      ...
      year: 2005,
      overview: [
        "Building a pitch arsenal is a multi-year project sequenced by physical maturity, mechanical foundation, and competitive context. Throwing pitches before the body is ready — or before the mechanics are solid — risks injury, bad habits, and stunted development. The best programs (including the Dodger system) follow a structured progression:\n- Fastball command first.\n- The changeup second.\n- Breaking balls only once the physical and mechanical prerequisites are established.",
        "Guidelines from the American Sports Medicine Institute, Pitch Smart (MLB/USA Baseball), and pro development programs converge on a consensus order:\n- Command before velocity.\n- Changeup before curveball.\n- Curveball before slider.\n- Splitter/forkball last (if ever).\nThe rationale is physiological (growth plates close bottom-to-top — elbow ~15–17, shoulder ~18–21) and mechanical (breaking balls before solid fastball mechanics create compensatory patterns that persist for years).",

    ...
    info: {
      ...
      technical: {
        ...
        body: [
          ...
          "Agility, strength, and arm care:\n- train quick feet and lateral agility for finding the bag and covering the 3-hole\n- build single-leg strength and balance for the stretch and the push off the base\n- strengthen legs, hips, and core for stable, powerful movement\n- care for the throwing arm (rotator cuff, scapular work) for accurate throws to second and around the infield\nSize helps the bat and reach, but mobility and agility drive the defense.",
        ],
        codeExample: {
  ...
  // ─── baseball-9-10: The Greats and Mastery ────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Mastering first base is about reliability above flash. The position's value comes from doing the routine perfectly and the difficult often:\n- catching every catchable throw\n- scooping the tough ones\n- finding the bag by feel\n- stretching to steal a step\n- never giving away a base through a mental lapse\nA first baseman who handles everything cleanly lets the rest of the infield play freely and aggressively. That dependability is the cornerstone of a good defense.",
      ...
      technical: {
        ...
        body: [
          "Skills to master:\n- receiving and scooping (soft hands on every throw, including the dirt)\n- footwork at the bag (find it by feel, set up, stretch)\n- holding runners and the pickoff tag\n- fielding the 3-hole and starting the 3-6-3 and 3-6-1\n- charging bunts and attacking the lead runner\n- serving as the cutoff man on right-side outfield hits\n- backing up bases\nEach is built through deliberate repetition.",

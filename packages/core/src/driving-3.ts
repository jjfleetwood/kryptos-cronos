...
export const driving3Stages: StageConfig[] = [
  ...
  // ─── driving-3-03: Road Rage ──────────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "De-escalation is always the correct response when another driver becomes aggressive — the goal is to separate yourself from them:\n- Don't make eye contact.\n- Don't gesture or yell back.\n- Don't brake-check them.\n- Don't speed up to 'keep up' with them.\nInstead, change lanes, slow down, or take a different exit. Matching aggression is how minor incidents become crashes or altercations.",
        "If an aggressive driver follows you or is threatening:\n- Do not drive home.\n- Drive to a police station or a busy public place, or call 911.\n- On California roads, reach CHP via 911 or #77 from a cell phone.\nStaying in your car in a public place with the doors locked is far safer than engaging or getting out.",
      ],
      technical: {
  ...
  // ─── driving-3-04: Sharing the Road ──────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2014,
      overview: [
        "California roads are shared by many users, each with different speeds, blind spots, stopping distances, and vulnerabilities:\n- Vehicles and motorcycles.\n- Cyclists and pedestrians.\n- School buses and large commercial trucks.\nSafe driving requires understanding the rules and realities of each — failing to share the road properly is a leading cause of pedestrian and cyclist fatalities.",
        ...
        "Yielding to vulnerable users has hard rules:\n- Pedestrians have the right of way in all marked crosswalks and many unmarked crosswalks at intersections — yield to anyone in or entering a crosswalk (they need not already be in your lane).\n- School buses with flashing red lights require a full stop in both directions on undivided roads.\nThe 3-foot passing law adds that if you can't give a cyclist 3 feet, you must slow and wait for a safe opportunity to pass.",
      ],
      technical: {
  ...
  // ─── driving-3-05: Car Care Basics ───────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Tires are the single most safety-critical maintenance item on a vehicle:\n- Low pressure increases braking distance and makes blowouts more likely.\n- Worn tread reduces traction, especially in the wet — the minimum legal tread in California is 2/32 inch (check with a penny: Lincoln's head disappears if you have enough tread).\n- Check pressure monthly and before any long trip; the recommended PSI is on the sticker inside the driver's door jamb.\nA few minutes on tires prevents a large share of crashes.",
        "Dashboard warning lights come in two urgency levels:\n- Red — stop driving as soon as safely possible: oil pressure, temperature, brake system, battery.\n- Yellow/amber — visit a shop soon, but not immediately dangerous: check engine, traction control, tire pressure.\nNever ignore a red warning light — driving further can cause catastrophic engine or brake damage.",
      ],
      technical: {
  ...
  // ─── driving-3-06: After a Crash ─────────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2005,
      overview: [
        "Every driver should know exactly what to do after a crash, because it's hard to think clearly in the immediate aftermath. California law imposes specific obligations on drivers involved in crashes:\n- Stop at the scene.\n- Provide your information.\n- Render aid if needed.\nLeaving the scene of a crash involving injury is a felony under California law.",
        ...
        "California requires you to file an SR-1 form (Report of Traffic Accident Occurring in California) with the DMV within 10 days when a crash involves:\n- Injury or death, or\n- Property damage exceeding $1,000 to any one person's property.\nFailure to file when required can result in license suspension — and this is separate from any police report, so you must file the SR-1 yourself.",
      ],
      technical: {
  ...
  // ─── driving-3-07: Breakdowns and Roadside Safety ────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "If your vehicle breaks down or you must pull over on a freeway:\n- Activate your hazard lights immediately.\n- Steer as far to the right as possible — onto the shoulder, against the guardrail if there is one.\n- If you can, exit at the next off-ramp rather than stopping on the freeway mainline.\n- Once stopped, leave hazards on, don't open the driver's door into traffic, and don't stand between your car and the travel lanes.\nFreeway shoulders are dangerous because traffic passes at high speed and drivers aren't always alert for stationary obstacles.",
        "On placing warnings and where to wait:\n- Emergency triangles or flares go 10 feet behind the vehicle and at 100 and 200 feet — the standard warning distance.\n- But on a freeway, CHP advises staying inside the locked vehicle (with seat belts on) rather than standing outside.\nA distracted driver hitting your stopped car is far more survivable from inside than outside the vehicle.",
      ],
      technical: {
  ...
  // ─── driving-3-08: Being a Good Driver ───────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2015,
      overview: [
        "Technical skill is only one part of being a good driver; the other is character — courtesy, patience, and responsibility:\n- Studies consistently show driver attitude and behavior predict crash risk better than most technical skills.\n- Drivers who treat the road as a shared resource and stay patient have significantly lower crash rates.\n- Those who drive aggressively or impatiently have higher crash rates.\nCharacter on the road isn't a soft extra — it's a measurable safety factor.",
        "The zipper merge is one of the most misunderstood points of driving courtesy:\n- When two lanes must merge into one, the safest and most efficient method is for both lanes to fill to the merge point and alternate — like a zipper.\n- Early mergers who treat late-lane users as 'cheaters' actually create longer, more congested backups.\nThe California DMV endorses late merging as the correct technique in lane-closure situations.",

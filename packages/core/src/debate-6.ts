...
export const debate6Stages: StageConfig[] = [
  // ─── debate-6-01: Ethos, Pathos, Logos ────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: -350,
      overview: [
        "Around 350 BCE, Aristotle analyzed persuasion into three appeals that remain the foundation of rhetoric: ethos, pathos, and logos. Logos is the appeal to reason — logic, evidence, sound argument (everything from the earlier epochs). Ethos is the appeal through the speaker's credibility and character — why the audience should trust you. Pathos is the appeal to emotion — connecting the argument to what the audience cares about and feels. Aristotle's insight was that real persuasion is rarely pure logic; humans are moved by a blend of being convinced (logos), trusting the speaker (ethos), and caring about the outcome (pathos). A debater who masters only logos persuades incompletely.",

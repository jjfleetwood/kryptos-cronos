...
export const nailsStages: StageConfig[] = [
  // ─── nails-01: Nail Anatomy & Prep Basics ────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The correct prep sequence is:\n- Remove old polish.\n- Trim and shape.\n- Push back and remove cuticles.\n- Lightly buff the nail plate.\n- Cleanse with a prep wipe.\n- Apply dehydrator.\n- Apply primer (optional but recommended).\n- Apply product.\nSkipping or reversing steps creates problems no amount of top coat can fix.",
      ],
      technical: {
  ...
  // ─── nails-02: The No-Water Rule ─────────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2005,
      overview: [
        "For decades the traditional manicure began with a finger bowl — soaking the hands in warm soapy water to soften the cuticles. It felt luxurious and made cuticle work easier, but it created an adhesion problem because nails are porous:\n- They absorb water and expand during the soak.\n- As the nail dries afterward, it contracts.\n- Anything bonded to the surface (base coat, gel, acrylic) is stressed by that contraction and separates from the nail plate.\nThe luxury came at the cost of longevity.",
        "The no-water rule, championed by product chemists and nail educators from the early 2000s, is simple — don't soak the nails before applying any product:\n- Do all cuticle work dry or with cuticle remover gel.\n- The nail surface stays dimensionally stable.\n- The dehydrator works on a nail that hasn't absorbed moisture, so the product bonds properly.\nThe payoff is a manicure that lasts days longer with no loss of quality.",
  ...
  // ─── nails-03: Dehydration & Primer ──────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "A primer is a separate product from a dehydrator — while a dehydrator removes what's present (oils, moisture), a primer adds something to the nail:\n- Acid-based primer — etches the nail plate microscopically for mechanical adhesion.\n- Acid-free primer — creates a molecular bridge between the nail plate and the product layer.\nPrimers are most commonly used with hard gel, acrylic, and builder-gel systems.",
        "Knowing when to use each product:\n- Dehydrator — on every service, always.\n- Primer — when working with enhancement systems (acrylic, hard gel, builder gel, BIAB); rarely needed for traditional polish or soak-off gel, though some technicians use an acid-free primer on clients prone to lifting.\nMatching the product to the service prevents both lifting and over-treatment.",
      ],
      technical: {
  ...
  // ─── nails-04: The Dry Manicure ───────────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2012,
      overview: [
        "A dry manicure is simply a manicure performed without soaking the nails in water — long the professional standard in nail enhancement, and now spreading to traditional polish services. The whole service is done on dry nails:\n- Cuticle removal using gel remover rather than soaking.\n- Shaping on dry nails.\n- Buffing on a dry surface.\nNothing about it sacrifices comfort or hygiene.",
        "The sequence of a complete dry manicure:\n- Remove any existing product or polish.\n- File and shape the nails to the desired length and shape.\n- Apply cuticle remover gel to the cuticle area.\n- After 30–60 seconds, gently push back the cuticle with a metal pusher or orangewood stick.\n- Use nippers to remove only loosened dead tissue — never cut living skin.\n- Lightly buff the nail plate to remove shine and create texture, then wipe with a lint-free pad.\n- Apply dehydrator, then primer if using enhancements, then proceed with your product.",
  ...
  // ─── nails-05: Even Polish Application ───────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2015,
      overview: [
        "Even polish application separates professional results from home manicures, and it rests on three principles:\n- Thin coats.\n- Proper brush technique.\n- Capping the free edge.\nMost people apply thick globs because it seems faster and more pigmented — but thick coats take longer to dry, trap air bubbles, shrink more as they cure, and are far more likely to smudge and chip.",
        "The three-stroke method is the professional standard:\n- Place the brush at the center base, about 1mm from the cuticle; press gently to fan the bristles, then pull straight to the free edge down the center.\n- Repeat from base to free edge on the left side.\n- Repeat on the right side.\nThree strokes, light pressure, thin coat — that's it.",
  ...
  // ─── nails-06: Base Coat, Color & Top Coat ───────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2018,
      overview: [
        "A professional manicure uses three distinct product layers, each with a specific function:\n- Base coat — the foundation: creates adhesion between the nail plate and color, prevents staining from pigmented polish, and often includes strengtheners.\n- Color coat — the pigment, always applied in two thin coats, never one thick one.\n- Top coat — seals and protects everything beneath, adds shine, and is the main defense against chips and scratches.\nEach layer must fully set before the next goes on.",
        ...
        "Not all base coats and top coats are interchangeable:\n- Ridge-filling base coats — thicker, for clients with uneven nail surfaces.\n- Strengthening base coats — contain calcium or keratin for fragile nails.\n- Quick-dry top coats — contain solvents that help polish set faster.\n- Gel top coats — require UV/LED curing.\nUsing the wrong product type can cause compatibility issues — always stay within the same system when possible.",
      ],
      technical: {
  ...
  // ─── nails-07: Troubleshooting Lifting ───────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2019,
      overview: [
        "Lifting is when polish or gel separates from the nail plate, usually starting at the cuticle edge or the sidewalls:\n- It's the most common complaint nail clients make.\n- It's almost always caused by prep errors, not the polish itself.\nThe specific pattern of lifting tells you exactly where in your prep routine the problem occurred.",
        "Lifting at the cuticle specifically means the product was applied too close to or touching the cuticle/eponychium:\n- When product touches living skin, the skin's oils and movement eventually break the seal.\n- The fix: leave a 1mm gap between your product and the cuticle.\nIt looks scary at first — like an unpainted gap — but once you apply your layers it becomes invisible.",
  ...
  // ─── nails-08: Troubleshooting Chipping ──────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2020,
      overview: [
        "Chipping is different from lifting:\n- Lifting is product separating from the nail plate.\n- Chipping is the tip or edge of the color breaking off — like a ceramic tile chipping at the corner.\nThe most common cause is a free edge that wasn't properly sealed: when the tip isn't capped with each product layer, the edge of the polish stack is exposed and vulnerable to impact.",
        ...
        "Other causes of chipping:\n- Lifestyle and water exposure — frequent hand-washing, swimming, or household chemicals weaken polish.\n- The nail being too long for the client's lifestyle.\n- Incorrect product choice — traditional polish chips faster than gel on clients with active hands.\nA frank conversation with clients about their lifestyle sets realistic expectations and helps choose the right service.",
      ],
      technical: {
  ...
  // ─── nails-09: Starting a Teen Nail Business ─────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2023,
      overview: [
        "Starting a nail business as a teenager is completely achievable — supplies are affordable, demand is constant, and you can start with friends and family to build a portfolio before charging professional rates. The key steps:\n- Build your skill to a consistent professional level.\n- Invest in a starter supply kit.\n- Document your work on social media.\n- Price your services correctly from the start.",
        ...
        "Social media is your best marketing tool at zero cost — Instagram and TikTok are visual platforms perfectly suited for nail art:\n- Post every set you do, even on yourself.\n- Use before-and-after photos, process videos, and satisfied-client posts to build credibility faster than any advertisement.\n- Use local hashtags to reach clients in your area.\nConsistent posting compounds into a real client pipeline.",
      ],
      technical: {
  ...
  // ─── nails-10: Opening a Nail Salon ──────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2023,
      overview: [
        "Opening a nail salon requires more than skill — it requires licensing, business structure, space, equipment, and operational systems. Several licenses are needed:\n- A nail technician license (typically 300–600 hours of cosmetology school plus a state board exam).\n- A separate salon license.\n- A business license from the city.\n- Compliance with health-department regulations.\nEvery US state requires the technician license; the others vary by locale.",
        ...
        "Startup costs for a small nail salon (2–4 stations) typically range from $15,000 to $50,000:\n- Equipment — $2,000–$5,000 per station (table, chair, client chair, lamp).\n- Build-out and decor — $5,000–$20,000.\n- Initial supplies — $2,000–$3,000.\n- Licensing and permits — $500–$2,000.\n- Working capital for the first 3–6 months of expenses.\nMany owners start by renting a booth inside an existing salon before taking on a full commercial lease.",
      ],
      technical: {

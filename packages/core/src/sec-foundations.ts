  ...
  // ─── 03: Change Management ─────────────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Exams emphasize the supporting pieces that make a change safe:\n- ownership and stakeholder identification plus approval workflows\n- standard operating procedures (SOPs) for routine pre-approved changes\n- allow/deny lists and firewall rules that may need updating\n- restricted activities and downtime planning for the window\n- the correct order of service and application restarts, honoring dependencies\nLegacy applications and undocumented dependencies are classic sources of change failures — restarting one service can cascade into others — so documentation and version control (updating diagrams, configs in Git, and runbooks) ensure the environment's true state is always known and changes are auditable.",

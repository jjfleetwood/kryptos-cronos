...
export const baseball4Stages: StageConfig[] = [
  // ─── baseball-4-01: Statcast and the Data Revolution ─────────────────────────
  {
    ...
    info: {
      ...
      year: 2015,
      overview: [
        "When MLB deployed Statcast tracking in all 30 ballparks in 2015, the game changed forever. For the first time, every batted ball could be measured with precision:\n- Exit velocity.\n- Launch angle.\n- Sprint speed.\n- Spin rate.\n- Arm strength.\n- Dozens of other variables.\nThe data produced new statistics that better predicted future performance than traditional metrics:\n- Expected batting average (xBA).\n- Expected slugging (xSLG).\n- Weighted on-base average (wOBA).\n- Barrel percentage.\n- Hard-hit rate.",
    ...
    info: {
      ...
      technical: {
        ...
        body: [
          ...
          "The practical use of a scouting card is not to memorize every number but to identify one or two actionable patterns per at-bat. Before stepping in, a hitter should know:\n- What pitch is most likely in the first-pitch and 0-0 count.\n- What pitch the pitcher throws when he has to throw a strike (ahead in the count).\n- What the pitcher goes to when he wants to get a swing-and-miss.\nThese three pieces of information shape the entire at-bat mental model.",
        ],
        codeExample: {
  ...
  // ─── baseball-4-03: Pre-At-Bat Rituals and Visualization ────────────────────
  {
    ...
    info: {
      ...
      year: 2004,
      overview: [
        "The on-deck circle is a preparation zone, not a waiting area. Elite hitters use every moment to accomplish several tasks at once:\n- Track the pitcher's delivery from a live angle to calibrate timing.\n- Review scouting information and refine the mental model for the at-bat.\n- Complete a physical warm-up that activates the muscles used in the swing.\n- Visualize the upcoming at-bat running to a successful outcome.",
        ...
        "Arousal control — managing physiological activation before and during at-bats — is critical for clutch performance:\n- Too little arousal (flat, unmotivated) slows reaction time and makes decisions passive.\n- Too much arousal (panicked, over-activated) degrades fine motor control and breaks down mechanics under pressure.\n- The ideal is the 'individual zone of optimal functioning' (IZOF) — different for every hitter.\nBreathing techniques, pre-at-bat routines, and step-in rituals all serve to regulate this level.",
      ],
      technical: {
  ...
  // ─── baseball-4-04: The Clutch At-Bat ────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2024,
      overview: [
        "High-leverage situations — runners in scoring position, late innings, close games — define careers and seasons, and the analytics on 'clutch' have evolved:\n- Early research suggested clutch performance was essentially random and unpredictable.\n- More recent Statcast work on plate discipline and contact quality shows elite hitters do maintain better approach and contact in high-leverage spots.\nThat points to mental preparation and approach consistency as genuinely clutch skills.",
        "How do elite hitters adjust with runners in scoring position (RISP)? The data shows they change their mental approach, not their swing:\n- They become more selective, waiting for a pitch in their optimal zone rather than expanding it out of anxiety.\n- They prioritize putting the ball in play over hitting for power.\n- They accept the walk as a positive outcome rather than forcing the issue.\nEssentially, the clutch approach is a heightened version of ideal plate discipline.",
  ...
  // ─── baseball-4-05: Platoon Splits and Matchup Hitting ───────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Managers have built lineup construction around platoon advantages for over a century, and the Dodgers under Dave Roberts have been especially aggressive:\n- Using specific hitters against certain-handed relievers.\n- Deploying platoon pairs at a position, splitting playing time by the opposing pitcher's handedness.\n- Stacking left-handed hitters against right-handed starters to maximize the lineup-wide edge.",
        "Switch-hitting is the ultimate platoon solution — batting from either side eliminates the handedness disadvantage entirely, and true elite switch-hitters are rare:\n- Mickey Mantle, Pete Rose, and Chipper Jones — the classic exemplars.\n- Dodger great Manny Ramirez, who handled same-handed pitching better than most hitters.\nThe mechanics demand two complete, separate swing paths — a skill that takes most hitters years to develop effectively.",
      ],
      technical: {
  ...
  // ─── baseball-4-06: Advanced Pitch Recognition Technology ────────────────────
  {
    ...
    info: {
      ...
      year: 2019,
      overview: [
        "The Edgertronic high-speed camera (2,000 frames per second versus broadcast video's 30) has transformed how teams study mechanics. At 2,000 fps, a pitcher's release reveals everything:\n- The exact finger position as the ball leaves the hand.\n- The seam orientation at release.\n- The spin axis.\n- The initial flight direction of every pitch.\nStudying it lets hitters spot pitch-specific release cues invisible in real-time or broadcast video — effectively a 'cheat code' for pitch recognition.",
        "Rapsodo (now standard in MLB and widely available at college and advanced-youth levels) measures ball-flight data with radar and camera tracking:\n- Spin rate and spin axis.\n- Pitch velocity.\n- Break displacement.\n- Release point.\nPitchers use it to design pitches; hitters use a pitcher's exact spin profile to prepare, and some teams build VR pitch-recognition scenarios tuned to opposing pitchers' Rapsodo profiles.",
  ...
  // ─── baseball-4-07: Position-Specific Hitting Expectations ──────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The spectrum runs from highest defensive demand / lowest offensive bar to the opposite end:\n- Catcher — highest defensive demand, lowest offensive expectation; a .240, 15-homer catcher is a strong offensive contributor because catchers who hit at all are rare.\n- First base / DH — lowest or no defensive demand, highest offensive requirement; that same .240, 15-homer line is below standard at a position with no defensive premium.\nThe harder the position is to play, the lower the offensive bar a player must clear.",
        "The Dodgers apply different wRC+ baselines (weighted runs created plus, park-adjusted, 100 = league average) by position:\n- A catcher at 90 wRC+ is productive; a first baseman at 90 is a liability.\n- A shortstop at 100 is exceptional; a DH at 100 is barely average.\nThis framework lets teams build better rosters and helps hitters contextualize their own production realistically.",
      ],
      technical: {
  ...
  // ─── baseball-4-08: Coaching the Swing ──────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1980,
      overview: [
        "Coaching hitting has a deep philosophical divide, framed historically by two figures who offered fundamentally different frameworks for what the swing should do:\n- Ted Williams (the greatest pure hitter of his era, .406 in 1941) believed in an upswing plane, attacking the inner half, and zone management by where a hitter can drive the ball best.\n- Charlie Lau (the innovator who transformed George Brett) emphasized weight transfer to the front foot, extension through the ball toward the pitcher, and a one-hand finish on the follow-through.",
        ...
        "The Dodgers' player-development philosophy under hitting coordinators like Robert Van Scoyoc is evidence-based:\n- Each hitter's Statcast data informs what to prioritize in practice sessions.\n- Mechanical changes are made incrementally rather than wholesale.\n- The goal is always improving contact-quality metrics rather than imposing a specific visual style on the swing.\nThis approach has helped the Dodgers develop or maximize hitters across a wider range of body types and swing styles than any previous era.",
      ],
      technical: {
  ...
  // ─── baseball-4-09: The Greatest Dodger Hitters — Technical Breakdown ────────
  {
    ...
    info: {
      ...
      year: 1947,
      overview: [
        "The Dodger franchise has produced technically instructive hitters, each embodying a different principle of mastery:\n- Jackie Robinson (1947–1956) — the complete hitter: bat control, discipline, situational awareness, bunting, slapping, and driving, all under unimaginable external pressure.\n- Duke Snider — the archetypal left-handed pull power hitter, a short load and explosive hip rotation that produced four home runs in two different World Series.\n- Mike Piazza — the right-handed pull power specialist whose elevated bat speed and upper-cut plane against fastballs made him the greatest offensive catcher in history.",
        "The eras since added more distinctive craftsmen:\n- Adrián Beltré (1998–2004) — a right-handed hitter who generated power on pitches below his knees through extraordinary hip flexibility.\n- Manny Ramirez (2008–2010) — one of his generation's greatest pure hitters: exceptional bat speed, elite pitch recognition, and an unhurried approach even in high-leverage at-bats.\n- Corey Seager — the modern launch-angle evolution, from a left-handed contact hitter to an elite power force through conscious, Statcast-supported approach changes.",
  ...
  // ─── baseball-4-10: Building a Lifelong Hitting Practice ─────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Age-specific adjustments are critical to a lifelong hitting career:\n- Youth (8–14) — emphasize fundamentals, contact rate, and bat control; power is irrelevant and mechanics should stay simple and consistent.\n- Teen (15–18) — begin integrating launch-angle awareness, pitch-recognition development, and approach refinement.\n- Adult amateur — maintain flexibility, protect mechanics from the changes of aging, and emphasize contact quality as bat speed naturally declines.",
        "What separates lifelong students of hitting from those who plateau isn't talent — it's curiosity and systematic self-evaluation:\n- They watch film on themselves and on pitchers consistently.\n- They keep journals of what worked and what didn't.\n- They seek out new information — a new drill, a different coaching perspective, a metric they hadn't tracked.\n- They treat every plateau as a problem to solve rather than a ceiling to accept.\nTed Williams said he spent more time thinking about hitting than anything else in his life — that relationship to the craft, not natural talent, is what produced a .406 batting average.",
      ],
      technical: {

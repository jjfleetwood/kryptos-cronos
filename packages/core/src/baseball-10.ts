...
export const baseball10Stages: StageConfig[] = [
  // ─── baseball-10-01: The Keystone ─────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Beyond fielding and the pivot, the second baseman covers second base on steals and certain bunts, serves as a cutoff and relay man on balls hit to the right side and to right-center field, and backs up bases. The position is a partnership: the second baseman and shortstop must constantly communicate about who covers the bag, who takes a relay, and how to position. Together they are the heartbeat of the infield defense — and the second baseman is the pivot at the center of it.",
      ],
      technical: {
  ...
  turns two and guards the middle.`,
      ...
      incident: {
        title: "Roberto Alomar — The Artist at Second Base",
        when: "1991–1995 — Toronto Blue Jays",
        where: "Rogers Centre (SkyDome), Toronto, Ontario",
        impact: "Roberto Alomar won ten Gold Gloves and helped Toronto win back-to-back World Series in 1992 and 1993, widely regarded as one of the most graceful and complete second basemen in history — a master of the pivot and the acrobatic play.",
        body: [
          "Roberto Alomar played second base with a grace that set the standard for the position. He turned the double play with an artistry that made the hardest pivots look effortless, ranged far to both sides, and made acrobatic plays — leaping throws, barehanded flips, plays from the seat of his pants — that few could imagine. During his peak with the Toronto Blue Jays, he anchored back-to-back World Series champions and won Gold Glove after Gold Glove.",
          "Alomar's brilliance came from fundamentals executed at an extraordinary level: quick, soft hands; footwork around the bag that flowed without wasted motion; and an instinct for where the play was. He is the model of the complete second baseman — not the biggest arm or the fastest runner, but the most skilled and creative defender, who turned the keystone position into an art form. Young players study him to learn that second base rewards skill, footwork, and feel above raw tools.",
        ],
      },
      diagram: {
        nodes: [
      ...
      timeline: [
        ...
        { year: 1991, event: "Roberto Alomar joins Toronto and redefines graceful second-base play", highlight: true },
      ...
      references: [
        ...
        { title: "Baseball Hall of Fame: Roberto Alomar", url: "https://baseballhall.org/hall-of-famers/alomar-roberto" },
      ],
    },
    quiz: {
      questions: [
  ...
  // ─── baseball-10-02: Positioning and Pre-Pitch Setup ──────────────────────────
  {
    ...
    info: {
      ...
      year: 2005,
      overview: [
        "Great defense starts before the pitch with positioning and the ready position. The second baseman's depth and lateral position change with the situation: normal depth for most situations, 'double-play depth' (a couple steps in and toward the bag) when a double play is needed so they can get to second quickly, and shallow ('infield in') when a run must be cut down at the plate. Positioning also shifts with the hitter — pull tendencies, power, and speed all influence where the second baseman stands.",
        "The ready position is the athletic stance every fielder assumes as the pitch is delivered: feet slightly wider than shoulder-width, knees bent, weight forward on the balls of the feet, glove out front, and a small timing hop or 'creep' step as the pitch reaches the hitter so the body is loaded and moving when the ball is struck. A fielder caught flat-footed loses the crucial first step; a fielder in a good ready position reacts instantly in any direction.",
  ...
  // ─── baseball-10-03: Fielding and Footwork ────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1996,
      overview: [
        "The second baseman must field ground balls cleanly to both sides: into the hole toward first base, and up the middle behind the second-base bag (the deepest, hardest throws). The fundamentals match every infielder: get a great first step from the ready position, take an efficient route to the ball, field it out in front of the body with the glove down and fingers pointing at the ground, watch it into the glove, and use two hands when possible for a quick, secure transfer. Footwork — getting the feet around and under the body — is what makes the throw possible.",
        ...
        "The transfer and footwork to throw are where plays are won or lost. After fielding, the second baseman gets the ball to a four-seam grip at the center of the body and steps toward the target to throw. On routine plays, set the feet and make a strong, accurate throw; on plays deep in the hole or up the middle, the second baseman may need to plant and throw across the body, flip, or even throw from an off-balance position. Practicing footwork from every angle builds the smooth, repeatable transfers that turn grounders into outs.",
      ],
      technical: {
  ...
  gather. Footwork BEFORE the glove.`,
      ...
      incident: {
        ...
        impact: "Second basemen like Roberto Alomar showcased how footwork and creativity could extend a fielder's range — making plays on the move, from the ground, and across the body that turned hits into outs and redefined expectations at the position.",
        body: [
          "The second baseman fields more balls on the move and from awkward positions than almost any infielder — ranging up the middle, diving into the hole, and flipping from the ground. Players like Roberto Alomar turned this into an art, making acrobatic plays look routine through superb footwork and soft, quick hands. Their range came not just from speed but from the ability to field from any position and instantly organize the feet to throw.",
      ...
      timeline: [
        ...
        { year: 1996, event: "Acrobatic second-base play popularized by Alomar and peers", highlight: true },
  ...
  // ─── baseball-10-04: Turning the Double Play (The Pivot) ──────────────────────
  {
    ...
    info: {
      ...
      year: 1992,
      overview: [
        "The pivot is the second baseman's most distinctive and difficult skill: receiving a feed at second base on a double play (a 6-4-3 started by the shortstop), touching the bag for the force out, and relaying to first to complete the double play — all while a runner is bearing down to slide into the bag. The pivot demands quick hands, footwork that gets the body into throwing position while clearing the runner, and the courage to make the throw with contact coming. A clean pivot turns one out into two and can end an inning or kill a rally.",
        "There are several pivot techniques, chosen by where the feed arrives and where the runner is. The most common is to catch the feed while stepping across the bag toward the outfield side, dragging or tapping the bag with the foot, then throwing to first as momentum carries away from the sliding runner. Other pivots include stepping behind the bag, straddling and pushing off, or the 'rock and throw' on a feed that takes the second baseman to the inside. The goal is always the same: touch the bag, get into a strong throwing position, and clear the runner.",
  ...
  ✓ 2016 slide rule: runner must slide legally to
    the bag (no taking you out)`,
      ...
      incident: {
        title: "Roberto Alomar's Effortless Pivot — 1992 World Series",
        when: "1992–1993 — Toronto Blue Jays World Series titles",
        where: "Wrigley Field and ballparks across the game",
        impact: "Roberto Alomar's pivot was a model of grace under pressure — quick hands, seamless footwork, and a lightning release that turned two while clearing hard slides, helping anchor back-to-back championship infields.",
        body: [
          "During Toronto's back-to-back championship runs, Roberto Alomar turned the double play with a fluidity that made the hardest pivots look effortless. He received feeds from any angle, found the bag without looking, and released the relay to first in an instant — clearing sliding runners with footwork so smooth it appeared he was never in danger. His pivot was a decisive weapon, ending innings and killing rallies in the biggest moments.",
          "Alomar's pivot was built on fundamentals executed at the highest level: soft, quick hands to secure any feed, footwork that flowed through the bag, and a quick release that beat both the runner and the throw. He chose the right pivot for each feed instinctively. For young players, his example shows that the pivot is mastered through repetition of footwork and hand quickness — and that getting rid of the ball fast is both the most effective and the safest way to turn two.",
        ],
      },
      diagram: {
        nodes: [
      ...
      timeline: [
        ...
        { year: 1992, event: "Roberto Alomar's graceful pivot anchors Toronto's championship defense", highlight: true },
  ...
  // ─── baseball-10-05: The Feed ─────────────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1998,
      overview: [
        "When the second baseman fields a ground ball near the bag with a double play in order, he becomes the feeder, delivering the ball to the shortstop covering second to start a 4-6-3 double play. The quality of the feed determines whether the shortstop can turn two: a feed delivered chest-high, slightly to the outfield side of the bag, on a straight line, and with a visible grip (so the shortstop sees the ball early) lets the shortstop catch, pivot, and throw in one motion. A poor feed — too hard, off-target, or hiding the ball — kills the double play.",
        "The type of feed depends on the distance and angle. From very close to the bag, a soft underhand toss (or 'feed') with a stiff wrist and the ball shown to the shortstop is best — gentle and accurate. From a few steps away, a backhand flip (delivered from the glove side) or a quick overhand-style dart may be used. From farther in the hole, a firmer throw with a four-seam grip. The cardinal rule is to take something off the throw so the shortstop can handle it cleanly — a 'catchable' feed beats a fast one.",
  ...
  // ─── baseball-10-06: Building the Second Baseman's Body ───────────────────────
  {
    ...
    info: {
      ...
      year: 2012,
      overview: [
        "Second base rewards quickness and agility over size and raw power. The position's physical priorities are lateral quickness (to range to both sides and reach balls in the hole and up the middle), first-step explosiveness (to break instantly from the ready position), core and rotational strength (to throw accurately from off-balance positions and to absorb contact on the pivot), and the footwork agility that ties it all together. A smaller, quicker, more agile player often makes a better second baseman than a bigger, stronger but slower one.",
        "Lower-body strength and single-leg stability are the foundation. Strong legs and glutes power the quick first step and the throws; single-leg strength and balance allow the second baseman to field and throw from unbalanced positions, plant and pivot, and clear runners on the double play. Agility and change-of-direction training — ladder drills, lateral movements, reaction drills — directly translate to range and footwork around the bag. The core is especially important because the second baseman so often throws across his body or from awkward angles.",
  ...
  // ─── baseball-10-07: Covering the Bag ─────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The conventional coverage: with a right-handed batter, the shortstop typically covers second base (the second baseman shades toward the first-base side to field a pulled ground ball); with a left-handed batter, the second baseman typically covers second (the shortstop holds the left side). The logic is to keep the fielder more likely to receive a batted ball in position while the other covers the bag. Teams adjust this based on the hitter, the pitch, and defensive game plans, but the principle is that coverage is pre-arranged and communicated every pitch.",
        "The tag on a steal must be quick and low. The covering fielder straddles or sets up at the bag, gives the catcher a target, catches the throw, and sweeps the tag down to the front edge of the bag where the sliding runner arrives — applying the tag low and letting the runner slide into it. As with all tag plays, catching the ball comes first; a great tag means nothing if the ball isn't secured. The second baseman also covers second on certain bunt plays and is responsible for the bag whenever his coverage assignment dictates.",
      ],
      technical: {
  ...
  // ─── baseball-10-08: Relays, Cutoffs, and Backups ─────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Being a good relay man means getting out to the right spot quickly, giving the outfielder a clear target (raised hands, calling for the ball), catching the throw on the glove side while turning toward the infield, and making a strong, accurate relay throw to the target base. The trailing infielder lines up the relay man with the target and tells him where to throw ('two!', 'three!', 'home!', or 'cut it'). Footwork is key: catch, turn glove-side, and throw in one motion without wasted time, because relays are races against fast runners.",
        "The second baseman also serves as a cutoff man on certain throws and backs up bases. He backs up second base on throws from the catcher (on steals when the shortstop covers), backs up first base on throws and pickoffs from certain angles, and is part of the relay-and-backup system that prevents extra bases on errant throws. As always, the second baseman must know before each pitch whether he'll be a relay man, a cutoff, a base coverer, or a backup on a ball hit to a given part of the field.",
      ],
      technical: {
  ...
  // ─── baseball-10-09: Situational IQ ───────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2000,
      overview: [
        "A complete second baseman plays the game mentally before each pitch. The key reads: how many outs, where the runners are, whether a double play is on, and what to do with the ball if it's hit to him — turn two, take the sure out at first, get the lead runner, or check a runner and throw to first. With a runner on first and fewer than two outs, the default is to turn two; but if the ball is hit slowly or the runner has a big jump, taking the sure out is smarter than forcing a double play that gets nobody.",
        "Depth and positioning decisions flow from the situation, as covered earlier: double-play depth with a runner on first, infield in to cut down a run, guarding against specific hitters. The second baseman also factors the speed of the runners (a fast runner may make the double play impossible, so take the sure out) and the score (in a blowout, the sure out; in a tie game late, the run-saving play). These judgments must be made before the pitch so the reaction is instant when the ball arrives.",
  ...
  Decide BEFORE the pitch → react in an instant.`,
      ...
      incident: {
        ...
        body: [
          ...
          "Roberto Alomar and other greats combined spectacular physical skills with this anticipation, seeming to know where the ball and the play were going before anyone else. Modern data informs positioning, but the in-the-moment decisions still belong to the player. For young players, the lesson is to think the game every pitch — to know the situation, the runners, and the plan — so that when the ball comes, the body simply executes a decision already made. Situational IQ is what makes the physical tools count.",
        ],
      },
      diagram: {
        nodes: [
  ...
  // ─── baseball-10-10: The Greats and Mastery ───────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2011,
      overview: [
        "The greatest second basemen share a set of pursuable traits: quick, soft hands; agile, efficient footwork to range to both sides and turn the pivot; the body control to throw from any position; the courage and quick release to turn two through hard slides; the unselfishness to deliver perfect feeds; and the situational intelligence to know the play before it happens. Roberto Alomar embodied all of it with a grace that made the position an art — but the qualities, not the highlight reel, are what to study and build.",
  ...
  Build these → you are the KEYSTONE.`,
      ...
      incident: {
        ...
        when: "1992–1993 — Toronto Blue Jays / 2011 Hall of Fame induction",
        where: "National Baseball Hall of Fame, Cooperstown, New York",
        impact: "Roberto Alomar's Hall of Fame career — ten Gold Gloves and back-to-back World Series titles — stands as proof that a second baseman's skill, footwork, and partnership can be the foundation of a championship defense.",
        body: [
          "Roberto Alomar was inducted into the Hall of Fame on the strength of a career that defined complete second-base play: ten Gold Gloves, twelve All-Star selections, and a central role on Toronto's back-to-back World Series champions. He turned two with effortless grace, ranged to both sides, made acrobatic plays, and anchored the middle of championship defenses through skill, footwork, and feel rather than raw power.",
      ...
      timeline: [
        { year: 1991, event: "Roberto Alomar sets the modern standard for complete second-base play" },
        { year: 1993, event: "Alomar anchors Toronto's second straight World Series title" },
        { year: 2003, event: "Defensive metrics credit second-base range, pivots, and feeds" },
        { year: 2011, event: "Roberto Alomar inducted into the Baseball Hall of Fame", highlight: true },
  ...
  baseman and asks which qualities to develop.`,
          ...
          correctIndex: 1,
          explanation: "The best second basemen combine quick, soft hands; agile, efficient footwork to range and pivot; the body control to throw from any position; the courage and quick release to turn two through slides; the unselfishness to deliver perfect feeds; and the situational IQ to know the play in advance. It's a complete skill set built on footwork and feel — not size or arm strength. Roberto Alomar embodied all of it.",
        },
        {
  ...
  defense.`,
        ...
        },
        {
          ...
          type: "Legacy",
          challenge: `  Roberto Alomar reached the Hall of Fame with ten
  Gold Gloves and two World Series titles, anchoring
  championship defenses from second base.`,
          text: "What does Alomar's career teach young second basemen?",
          options: [
          ...
          correctIndex: 1,
          explanation: "Alomar's Hall of Fame career — built on ten Gold Gloves and back-to-back titles — proves that mastering the complete craft of second base can make a player the cornerstone of a championship defense. His grace came from footwork, the pivot, the feed, the partnership with his shortstop, and his anticipation. The lesson for young players is to pursue that whole craft and become the keystone the entire infield turns on.",
        },
      ],
    },
  },

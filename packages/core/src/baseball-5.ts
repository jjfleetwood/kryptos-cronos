...
export const baseball5Stages: StageConfig[] = [
  // ─── baseball-5-01: The Pitching Rubber and Stance ───────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "There are two primary pitching stances: the windup and the stretch. The windup is used with the bases empty or with runners who pose no steal threat; it features:\n- A rocker step back.\n- A leg lift.\n- A full hip rotation that generates maximum velocity.\nThe stretch is used with runners on base; it features:\n- A more compact initial stance.\n- A smaller leg lift.\n- A faster delivery to the plate, to minimize the catcher's time to throw out baserunners.\nSome pitchers use only the stretch even with the bases empty for consistency.",
  ...
  // ─── baseball-5-02: The Grip ─────────────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2019,
      overview: [
        "The grip is how a pitcher communicates with the baseball — every movement (rise, sink, cut, curve) originates in how the fingers and wrist impart spin at release. The four-seam fastball grip is the universal foundation:\n- Index and middle fingers across the widest part of the seams (the two farthest apart).\n- Thumb underneath the ball.\n- Ring and pinky fingers tucked to the side.\nIt produces pure backspin and maximum velocity — the straightest, fastest pitch a pitcher can throw.",
        "Finger pressure is the most underappreciated element of grip mechanics:\n- More pressure with the index finger pushes the ball arm-side (left for a right-hander), creating a two-seam fastball with natural run.\n- More pressure with the middle finger moves the ball the other way.\nThe four-seam-to-two-seam difference is subtle — two fingers positioned slightly differently on the seam — but the movement gap can be four to six inches at the plate.",
  ...
  // ─── baseball-5-03: The Delivery: Wind-Up Mechanics ─────────────────────────
  {
    ...
    info: {
      ...
      year: 1963,
      overview: [
        "The windup is a sequence of linked mechanical events where each phase positions the pitcher for maximum force generation in the next. The delivery is a kinetic chain — from the initial stance on the rubber through these phases:\n- Rocker step.\n- Leg lift.\n- Hip load.\n- Stride.\n- Arm action.\n- Release.\nIf any link breaks down, the chain loses force and accuracy. Understanding the windup as a sequence — rather than a single fluid motion — gives coaches and pitchers the ability to diagnose and fix mechanical problems.",
  ...
  // ─── baseball-5-04: The Delivery: Arm Action ────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2001,
      overview: [
        "Arm action is the path the throwing arm travels from hand separation at the chest through release and follow-through. Unlike the swing, there's no single correct form — successful pitchers vary widely:\n- Sandy Koufax threw straight over the top.\n- Pedro Martinez threw from a three-quarter slot.\n- Randy Johnson fired from a nearly sidearm position.\nEach arm slot gives hitters a different visual plane and produces different movement profiles on pitches.",
        ...
        "Elbow height at release varies by arm slot, but one rule is universal — the elbow should be at or above shoulder height at release:\n- Sub-elbow release points place the ulnar collateral ligament (UCL) in a compromised position.\n- That's the ligament damaged in the Tommy John epidemic that has affected hundreds of MLB pitchers.\nLittle League arm-care guidelines specifically warn against dropping the elbow below shoulder height, especially on high-effort throws.",
      ],
      technical: {
  ...
  // ─── baseball-5-05: Release Point and Command ────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2017,
      overview: [
        "The release point is the precise three-dimensional location where the pitcher's fingers leave the ball — not a single point per pitch, but an ideal the pitcher works to reproduce on every delivery. When it moves even slightly, pitches miss their target proportionally, often by several inches at the plate:\n- Too early or too late along the arm path.\n- Too high or too low in space.\nConsistency is everything: the same release point every time is what makes pitches land where the pitcher intends.",
        "Command is the ability to locate pitches precisely, especially on the corners. The 'black' — the dark border of home plate that experienced pitchers use as a reference — is the command artist's target, and hitting it in different spots is effectively throwing to three zones:\n- The inner black — jamming the hitter.\n- The outer black — off the edge away.\n- The low black — down at the knees.\nClayton Kershaw's career has been defined by locating to the black with exceptional consistency.",
  ...
  // ─── baseball-5-06: The Stretch and Holding Runners ─────────────────────────
  {
    ...
    info: {
      ...
      year: 2020,
      overview: [
        "With runners on, the pitcher's job changes — holding runners becomes as important as pitch quality. The stretch is the primary tool: a compressed delivery that cuts the catcher's throw time and the runner's jump. But the stretch alone isn't always enough, so elite pitchers add:\n- Pickoff moves to first, second, or third.\n- Slide steps to speed the delivery home.\n- Varied timing so runners can't time the jump.\nKeeping runners honest is its own craft.",
        "The pickoff is a legal deceptive throw to a base — to catch a runner off or force them to shorten their secondary lead — and the rules differ by base:\n- First base — the pitcher must step toward first before throwing.\n- Second base — multiple legal approaches exist.\n- Third base — step directly toward third.\nAn illegal move (or other windup/stretch violation) is a balk, advancing all runners one base.",
      ...
      technical: {
        ...
        body: [
          "A balk is called when a pitcher makes an illegal motion during a delivery or pickoff attempt while runners are on base. The most common balks are:\n- starting the windup and stopping (a pitcher who starts any movement toward the plate must complete the pitch)\n- failure to come to a set stop in the stretch\n- stepping toward one base and throwing to another\n- dropping the ball on the rubber\n- pitching from in front of the rubber without having a foot on it\n- making a fake throw to first base (illegal — throwing to first requires an actual step)",
  ...
  // ─── baseball-5-07: Velocity and Why It Matters — And Doesn't ───────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Velocity is determined by several biomechanical factors:\n- hip rotation speed (the primary driver)\n- leg drive from the rubber\n- arm path efficiency (a clean path wastes no energy)\n- body mass (more mass moving toward the plate = more force)\n- flexibility (a more flexible pitcher can achieve greater external rotation, which increases the acceleration window)\nMost of these factors can be improved with training — velocity is not entirely genetic, though there is a ceiling for each individual.",
      ...
      technical: {
        ...
        body: [
          "Greg Maddux won four consecutive Cy Young Awards (1992–1995) and finished with 355 career wins while rarely exceeding 91 mph on his fastball. His approach was built on three principles:\n- Throw as few pitches as possible by generating ground balls and weak contact early in counts.\n- Change speed to disrupt timing rather than overpowering hitters.\n- Locate precisely on the corners to force hitters to swing at pitches they cannot drive.",
  ...
  // ─── baseball-5-08: Pitch Count and Arm Care ────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2006,
      overview: [
        "Little League adopted mandatory pitch-count rules in the 2006–2007 changes, and they weren't arbitrary:\n- Maximum pitches per day by age group.\n- Mandatory rest periods before a pitcher can throw again.\nThey were a direct response to a surge in youth arm injuries — particularly UCL tears requiring Tommy John surgery — that researchers at the American Sports Medicine Institute linked to overuse starting as young as nine and ten years old.",
        ...
        "At the professional level, the Dodgers under GM Andrew Friedman and manager Dave Roberts run a sophisticated workload-management philosophy, tracking starters on:\n- Innings pitched and pitch count.\n- Days of rest.\n- Cumulative fastball-velocity decline within a start.\nStarters who lose more than 2 mph on their fastball are pulled regardless of pitch count — velocity drop is an objective fatigue signal that shows up before the pitcher consciously feels it.",
      ],
      technical: {
  ...
  // ─── baseball-5-09: Fielding Your Position (PFP) ─────────────────────────────
  {
    ...
    info: {
      ...
      year: 2021,
      overview: [
        "Pitchers are the team's tenth fielder — after delivering, they become a defender. Pitcher fielding practice (PFP) drills the responsibilities unique to the position:\n- Covering first base on grounders hit to the right side.\n- Fielding comebackers hit sharply back at the mound.\n- Backing up bases on throws from the outfield.\n- Defending bunts.\n- Positioning for run-down plays.",
        "Covering first is the most common and most critical PFP skill. On any ground ball to the first or second baseman with the first baseman pulled toward the line, the pitcher must get to the bag — a practiced running route:\n- Break immediately toward the grass-dirt line, about 45 feet from home.\n- Run parallel to the foul line.\n- Reach the bag in time to receive the throw and step on it.\nFailing to break instantly on a right-side grounder hands the offense a free out.",
  ...
  // ─── baseball-5-10: Mental Approach on the Mound ────────────────────────────
  {
    ...
    info: {
      ...
      year: 2022,
      overview: [
        "The mental game of pitching is as demanding as the physical. A pitcher stands alone, responsible for every pitch, with each mistake instantly becoming a strikeout or a ball over the fence. The psychological demands are unique in team sports:\n- Managing failure pitch after pitch.\n- Maintaining focus under pressure.\n- Adjusting to adversity in real time.\nA pitcher who can't manage the mental game can't hold their mechanics together under the stress competitive pitching produces.",
        ...
        "Breathing technique is the physiological tool that bridges mental state and physical execution. Deep diaphragmatic breathing (into the belly, not the chest) activates the parasympathetic nervous system:\n- Heart rate drops.\n- Cortisol falls.\n- Fine motor control is restored.\nA pitcher who takes a slow, deliberate breath behind the mound after a bad inning isn't showing weakness — it's a documented physiological reset to the optimal performance state.",
      ],
      technical: {

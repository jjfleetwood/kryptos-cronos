...
export const hairColorStages: StageConfig[] = [
  // ─── hair-color-01: Hair Structure & Color Science ────────────────────────────
  {
    ...
    info: {
      ...
      year: 1907,
      overview: [
        "Hair is not a solid rod — it has three distinct layers:\n- Cuticle (outermost) — overlapping scales, like roof tiles or fish scales, that protect the inner shaft.\n- Cortex (middle) — the largest part of the hair, made of keratin proteins and containing the hair's natural pigment (melanin).\n- Medulla (innermost) — a soft central core present in coarser hair types, sometimes absent in fine hair.",
  ...
  // ─── hair-color-02: The Level System ──────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1975,
      overview: [
        "The hair-color level system is a standardized numerical scale from 1 to 10 measuring lightness or darkness — regardless of tone:\n- Level 1 is the darkest (black); Level 10 is the lightest (platinum blonde).\n- Every natural and artificial color is assigned a level.\n- The level only tells you how light or dark, not the tone — a Level 6 could be a warm golden brown or a cool ash brown.\nIt's the first number you read in any formula.",
        ...
        "The rule of thumb for how many levels you can lift with standard permanent color plus developer:\n- 20 volume — 1–2 levels.\n- 30 volume — 2–3 levels.\n- 40 volume — 3–4 levels.\nGoing more than 4 levels lighter with standard color (without bleach) usually produces unsatisfactory results — the underlying pigment remains and creates unwanted warm tones.",
      ],
      technical: {
  ...
  // ─── hair-color-03: Tones & the Color Wheel ──────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1990,
      overview: [
        "Tone describes the warmth or coolness of a color at any given level — a Level 7 can be warm (golden, copper), neutral, or cool (ash, matte). It's the second half of the formula number (in 7.1, the 7 is the level and .1 is the ash/cool tone). Common tone codes vary by brand but typically run:\n- .1 = ash, .2 = violet, .3 = gold.\n- .4 = copper, .5 = mahogany.\n- .6 = red, .7 = brown.\nReading both numbers tells you level and tone at a glance.",
        "The color wheel — the foundational tool of color theory — applies directly to hair:\n- The primary colors are red, yellow, and blue.\n- Opposite colors on the wheel are complementary and cancel each other when mixed.\nThat's the principle behind toning: orange brassy tones are canceled by blue-violet, yellow by purple, and red by green.",
  ...
  // ─── hair-color-04: Developer & Lift ──────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1950,
      overview: [
        "Developer (oxidant, peroxide) is hydrogen peroxide (H₂O₂) diluted to various concentrations — the activating ingredient in permanent and demi-permanent color, without which there's no lift and no permanent deposit. It comes in volumes:\n- 10 volume — 3% H₂O₂.\n- 20 volume — 6%.\n- 30 volume — 9%.\n- 40 volume — 12%.\nThe volume number indicates the oxygen released: higher volume means more oxygen, more lift, and more hair-damage potential.",
        ...
        "Choosing the correct developer volume is a critical skill — use the lowest volume that achieves the desired lift:\n- 10 volume — deposit-only (going darker or same level), no lift.\n- 20 volume — the standard for 1–2 levels of lift or full grey coverage.\n- 30 volume — 2–3 levels of lift.\n- 40 volume — maximum lift (3–4 levels), typically only used in lighteners, not standard color formulas.\nMatching volume to the goal protects the hair.",
      ],
      technical: {
  ...
  // ─── hair-color-05: Permanent vs Semi vs Demi ────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2000,
      overview: [
        "There are three main categories of professional hair color, by how long they last and how they work. Permanent color:\n- Uses an alkaline developer to open the cuticle, remove melanin, and deposit oxidative color molecules that polymerize inside the cortex.\n- Those molecules are too large to exit, so it's truly permanent until the hair grows out or is cut.\n- It can both lift (lighten) and deposit, provides full grey coverage, and lasts until regrowth.\nIt's the most powerful and most committed option.",
        ...
        "Demi-permanent color is the gentlest option for color change:\n- Uses a low-volume developer (5–10 volume) with no ammonia (or very little).\n- Enters the cortex via the slightly-open cuticle but can't significantly lift melanin.\n- Lasts longer than semi-permanent (20–28 shampoos) and covers grey partially to fully depending on the percentage.\nIt's excellent for toning, glazing, and refreshing faded permanent color.",
      ],
      technical: {
  ...
  // ─── hair-color-06: Safety — Skin Tests & Strand Tests ───────────────────────
  {
    ...
    info: {
      ...
      year: 2015,
      overview: [
        "Before any chemical color service, two tests should be conducted — professional and legal responsibilities, not optional extras:\n- A skin allergy test (patch test) — because para-phenylenediamine (PPD), common in permanent and demi-permanent color, is a known allergen whose reactions range from contact dermatitis to life-threatening anaphylaxis.\n- A strand test — to see how the hair will respond to the formula.\nThe patch test is done 48 hours before the service to catch PPD sensitivity before product touches the whole scalp.",
        "The patch test procedure:\n- Cleanse a small area inside the elbow or behind the ear.\n- Apply a small amount of the color formula (mixed at the service ratio) to the skin; do not cover it.\n- Leave for 48 hours.\nIf redness, swelling, itching, or blistering occurs, the service must not proceed and the client should see a doctor; if no reaction, proceed with the service.",
  ...
  // ─── hair-color-07: Root Application & All-Over Color ────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "For a root touch-up (new growth only):\n- Section the hair into four quadrants — a center part from forehead to nape, and an ear-to-ear parting.\n- Work through each section in subsections 1/4 to 1/2 inch wide.\n- Apply color precisely to the new growth only, not touching previously colored hair.\n- Start in the most resistant area first — typically the grey-dense areas or crown.\nOverlapping onto colored ends is a leading cause of over-processed, damaged midlengths.",
        "For an all-over color (entire head, usually a first-time color), order matters because the roots process faster from body heat:\n- Apply color to the midlengths and ends first.\n- Apply to the roots only in the final 10–15 minutes of processing.\nIf roots go on first, they'll be over-processed by the time the rest is done — so work quickly and systematically through all sections.",
      ],
      technical: {
  ...
  // ─── hair-color-08: Bleaching & Lightening ────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Bleach formulation has several variables:\n- The lightening powder's chemical type — persulfate-based powders are standard.\n- The developer volume — 20 for scalp applications; 30–40 for off-scalp foils on resistant hair.\n- The mixing ratio.\n- Whether the mixture contains additives for hair health.\nHigher volumes and longer processing times produce more lift but also more damage — the goal is the desired lift with the minimum damage possible.",
        "The most critical safety rules for bleaching:\n- Never apply bleach to a scalp that's been scratched, abraded, or has open sores.\n- Never process past the point of desired lift — once melanin is removed it can't be replaced.\n- Never apply bleach to recently relaxed hair (bleach + relaxer overlap = breakage or complete dissolution).\n- Don't apply heat to bleach on the scalp — it accelerates processing unpredictably.\nBleach only lifts; it never deposits, leaving a lighter, more porous, weaker fiber.",
      ],
      technical: {
  ...
  // ─── hair-color-09: Toning & Corrective Color ────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Corrective color is the broader category of fixing color that went wrong — from a previous salon visit or at-home application. Before beginning any correction, a thorough analysis is required:\n- What is the current level and tone?\n- What tone is unwanted?\n- Why did the previous service fail?\n- What is the hair's current condition and porosity?\n- Is correction possible in one session, or will it take multiple visits?\nSkipping this analysis is how a correction becomes a second disaster.",
        "The most common corrections:\n- Brassiness after bleaching — apply a blue or violet toner.\n- Color that came out too dark — lift first with bleach or color remover.\n- Hot roots (roots lighter than lengths) — usually scalp heat; apply a darker formula to the roots or tone to blend.\n- Uneven color — a color melt or toning to unify.\nToning itself deposits tone without significant lift, taking lifted hair to a polished finish.",
      ],
      technical: {
  ...
  // ─── hair-color-10: Building a Hair Coloring Business ────────────────────────
  {
    ...
    info: {
      ...
      year: 2023,
      overview: [
        "Becoming a professional hair colorist starts with credentials and specialization:\n- A cosmetology license — typically 1,000–1,500 hours of school plus a state board exam.\n- Color specialization through brand education, advanced courses, and certifications, which differentiates you in a competitive market.\nMajor brands (Redken, Wella, L'Oréal Professional, Schwarzkopf) offer free and paid education programs that give colorists both skills and brand credibility.",
        ...
        "Building a color clientele takes time — typically 2–3 years to be consistently fully booked as a new colorist. Strategies:\n- Document every color result on social media.\n- Specialize in a signature technique — balayage, blonde specialist, vivid colors.\n- Request referrals from every satisfied client.\n- Partner with photographers and local bloggers for portfolio content.\nConsistency compounds: a strong, specialized portfolio is what fills the books.",
      ],
      technical: {

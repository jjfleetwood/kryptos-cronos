...
export const baseball7Stages: StageConfig[] = [
  // ─── baseball-7-01: Reading the Batter ───────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1965,
      overview: [
        "Before a pitch is thrown, a pitcher and catcher can gather enormous information from the batter's setup in the box. Several setup cues reveal a hitter's preferences, vulnerabilities, and likely weaknesses:\n- Stance width.\n- Weight distribution.\n- Hand height.\n- Grip tightness on the bat.\n- Stride-direction tendencies.\n- How deep or shallow the batter stands relative to home plate. This is not guesswork — it is systematic observation that professional pitchers and catchers train over years.",
  ...
  // ─── baseball-7-02: Working the Count ────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2011,
      overview: [
        "Count management is one of the most analytically studied parts of pitching:\n- Batters hit dramatically better in hitter's counts (2-0, 3-1, 3-2) and far worse in pitcher's counts (0-2, 1-2).\n- A first-pitch strike is the single most important pitch in any at-bat — it shifts the count before the batter can read tendencies or adjust.\nPitchers who consistently throw first-pitch strikes dominate; those who fall behind struggle.",
        "The 0-2 count is a gift for the pitcher — the batter must protect the plate, so the pitcher can attack or 'waste' a pitch just off the zone to bait a chase:\n- An eye-level fastball above the zone.\n- A curveball in the dirt.\nIf the batter swings and misses, the at-bat ends; if they take it, it's 1-2 and the pitcher still has the upper hand.",
  ...
  // ─── baseball-7-03: Pitch Sequencing ─────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1988,
      overview: [
        "Pitch sequencing is using one pitch to set up the next. The classic example is fastball-in, then curveball-away:\n- Establish that you can put a fastball on the inner half.\n- Make the batter respect it and start protecting inside.\n- Throw a curveball or changeup that looks inside, then breaks away to the outer half.\nThe batter is committed to protecting inside; the ball ends up where they can't catch up.",
        "A setup pitch is thrown to create an expectation or a mechanical commitment in the batter, not necessarily to get an out:\n- Three straight fastballs on the outer half may exist only to establish a pattern.\n- The payoff pitch — a curveball that starts outer-half and breaks further away, or a fastball inside after three away — then plays dramatically better.\nThe batter's body memory and timing become an asset for the pitcher.",
  ...
  // ─── baseball-7-04: First Time vs. Third Time Through the Order ───────────────
  {
    ...
    info: {
      ...
      year: 2020,
      overview: [
        "One of modern baseball's biggest analytical findings is the 'times through the order penalty' — hitters improve measurably each time they face a starter:\n- First time through — batters have no read on velocity, movement, or sequencing.\n- By the third time — they've seen every pitch in multiple counts and locations, and adjusted.\nOPS against starters typically climbs 15–20 points each time through the order.",
        ...
        "The Opener — starting a reliever for an inning or two before a long reliever takes over — was pioneered by the Tampa Bay Rays and adopted across baseball, including the Dodgers' 2020 championship run:\n- Matchup-optimize the first inning with the pitcher who has the best platoon edge against the top of the lineup.\n- Then hand off to the 'bulk pitcher' who covers innings 2 through 5.\nIt attacks the order penalty by changing looks before hitters can settle in.",
      ],
      technical: {
  ...
  // ─── baseball-7-05: Pitching from the Stretch ────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2014,
      overview: [
        "Pitching from the stretch changes a pitcher's rhythm, mechanics, and mental process:\n- From the windup, a full leg kick and load generate maximum velocity and movement.\n- From the stretch, the delivery is abbreviated so the catcher has a chance to throw out a base-stealer — reduced leg kick, quicker delivery, different timing.\nThe tradeoff: pitchers often lose 1–3 mph from the stretch, and breaking-ball movement can shrink.",
        "The mental checklist with runners on is multi-layered, all before the pitch:\n- Check the runner and their primary lead.\n- Decide on tempo variation — quick delivery vs. regular.\n- Determine whether a pickoff attempt is warranted.\n- Read the catcher's signs while tracking the runner.\n- Decide whether to vary the time between signs and delivery to disrupt the runner's timing.\nAll of it must happen without losing focus on the batter, who remains the primary threat.",
  ...
  // ─── baseball-7-06: High-Leverage Situations ─────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2017,
      overview: [
        "High-leverage situations fundamentally change the math of pitch selection:\n- Bases loaded, one out, tie game.\n- Tying run on second, two outs, bottom of the ninth.\n- Runner on third, nobody out.\nIn low leverage a pitcher can nibble and waste pitches; in high leverage the cost of a walk soars — with the bases loaded, a walk scores a run without the defense touching the ball.",
        "The central tension in high-leverage pitching is attack vs. nibble:\n- Attack the zone — throw strikes, trust your stuff, accept the risk of contact.\n- Nibble the edges — try to be perfect, risk walks, fall behind in counts.\nAnalytics are clear that nibblers fail at higher rates: a bases-loaded walk is guaranteed damage; a ball put in play can be fielded. Attacking forces the batter to earn any run.",
  ...
  // ─── baseball-7-07: Platoon Matchups and Handedness ──────────────────────────
  {
    ...
    info: {
      ...
      year: 2017,
      overview: [
        "The platoon advantage is one of baseball's most consistent, exploitable edges — batters hit far better against opposite-handed pitchers:\n- A same-side pitch (lefty-on-lefty, righty-on-righty) angles away from the batter's contact zone.\n- Same-side breaking balls break away — harder to track and to drive.\nIt's not marginal: for many batters the platoon split is 50–80 points of OPS.",
        ...
        "The Dodgers have long built bullpens to exploit platoon edges systematically. Under GM Andrew Friedman, the roster pairs lefties and righties against NL West tendencies:\n- Alex Vesia (left-handed) — a devastating slider against left-handed batters.\n- Evan Phillips (right-handed) — a sinker dominant against right-handed contact hitters.\nEach was acquired with an explicit matchup function in mind.",
      ],
      technical: {
  ...
  // ─── baseball-7-08: Studying Hitters with Video and Data ─────────────────────
  {
    ...
    info: {
      ...
      year: 2015,
      overview: [
        "Modern pitching prep is data-intensive, starting 48–72 hours before a start. Dodger starters review:\n- Statcast tendency reports.\n- Spray charts.\n- Chase rate by zone.\n- Exit velocity by pitch type.\n- Video of each hitter against pitchers with similar arsenals.\nThe goal is a specific but adaptable game plan that identifies each hitter's weaknesses and the pitches most likely to exploit them — before the first batter steps in.",
        "Each chart answers a different question:\n- Spray charts show where a hitter puts the ball in play — a pull-heavy hitter (most hits to the left side for a righty) probably struggles with outer-half pitches; an opposite-field hitter may struggle with inside fastballs.\n- Exit velocity by zone shows which areas a hitter damages most and which produce weak contact.\nPitching to the weak-contact zones is the logical extension.",
  ...
  // ─── baseball-7-09: Managing Fatigue ─────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The early fatigue signs Dodger pitching coaches track in real time:\n- Velocity decline of 2 mph or more from the starter's first-three-innings average.\n- Increased location deviation — pitches missing targets by wider margins than earlier.\n- Reduced spin on breaking balls — shorter curve, less cut on the slider.\n- Mechanical tells — elbow position on follow-through, hip-rotation timing.\nStatcast lets coaches track all of these pitch-by-pitch.",
        "Tommy John surgery (UCL reconstruction) takes 12–18 months to recover from, and about 20% of pitchers never return to their pre-surgery level — so prevention wins out:\n- Pitch-count management.\n- Mechanical efficiency.\n- Strengthening programs.\n- Aggressive rest at the first signs of fatigue.\nThe Dodgers have invested heavily in biomechanical analysis at Camelback Ranch to catch early fatigue signals before they become injuries.",
      ],
      technical: {
  ...
  // ─── baseball-7-10: Greatest Dodger Pitchers ─────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1963,
      overview: [
        "The Los Angeles Dodgers have produced the most concentrated run of elite starters in baseball history:\n- Sandy Koufax (1955–1966) — dominance through elegant simplicity: two pitches, mechanically perfect, elite velocity and movement.\n- Don Drysdale (1956–1969) — power plus psychological intimidation, owning the inner half and daring hitters to challenge it.\n- Fernando Valenzuela (1980–1990) — brought the screwball (breaking opposite a conventional curveball) to mainstream consciousness, paired with a unique delivery that disrupted timing.",
        ...
        "Each of these five Dodger legends teaches a different strategic lesson:\n- Koufax — simplicity and dominance through execution.\n- Drysdale — ownership of the inner half and psychological control.\n- Valenzuela — unconventional pitches create unconventional problems for hitters.\n- Hershiser — sequencing and intelligence outlast velocity.\n- Kershaw — the synthesis of all approaches, applied through decades of relentless work, produces the greatest career.",
      ],
      technical: {

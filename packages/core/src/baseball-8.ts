...
export const baseball8Stages: StageConfig[] = [
  // ─── baseball-8-01: The Field General ─────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2004,
      overview: [
        "The catcher is the quarterback of the defense — from a crouch behind the plate, the one player facing all eight teammates and the entire field. That perspective means far more than receiving pitches:\n- Calling pitches and locations.\n- Directing where fielders position.\n- Telling everyone how many outs there are and reminding teammates of the situation.\n- Quarterbacking cutoffs and relays on balls hit to the outfield.\nNo other position touches the game on every single pitch.",
        "Catcher is the most physically demanding and mentally engaged position on the diamond:\n- A catcher crouches and rises 120-plus times per game.\n- They absorb foul tips and blocked balls.\n- They manage the pitcher's emotions — and never get a mental break, because there's no pitch they aren't part of.\nCoaches often say the best athlete with the highest baseball IQ and toughest temperament should catch, because the catcher's decisions and leadership ripple through the whole defense.",
  ...
  // ─── baseball-8-02: The Catcher's Stances ─────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2019,
      overview: [
        "A catcher uses different stances for different situations. The primary stance (relaxed; no runners on, fewer than two strikes) prioritizes a low, comfortable target and a quiet body so the pitcher can find the glove:\n- Feet roughly shoulder-width, weight on the inside balls of the feet.\n- Glove relaxed out front as a quiet target.\n- Throwing hand protected behind the glove or behind the back to avoid foul-tip injuries.",
        ...
        "The modern one-knee stance has transformed catching since around 2019. Dropping a knee to the ground with no runners on creates a lower, more stable platform:\n- It improves framing of low pitches.\n- It reduces strain on the legs over a long season.\n- The trade-off is reduced mobility for blocking and throwing.\nMost catchers use one-knee setups with the bases empty and revert to a more athletic stance with runners on — knowing which stance fits the situation is a core catching skill.",
      ],
      technical: {
  ...
  // ─── baseball-8-03: Receiving and Framing ─────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2015,
      overview: [
        "Receiving is the catcher's most frequent skill — nearly every pitch — and framing is the art of receiving borderline pitches so they're more likely to be called strikes:\n- It is NOT 'pulling' a ball into the zone with a big, obvious yank — umpires see through that and may even punish it.\n- Real framing is subtle — catch with a relaxed glove, let the ball travel deep, and present it as a strike with a quiet, controlled hand.\nThe goal is to make a strike look like a strike, not to fake one.",
        "The fundamentals of receiving:\n- A relaxed, slightly open glove — not stabbing at the ball.\n- Catch the outer half of the ball so the glove naturally moves toward the zone.\n- 'Stick' the pitch — hold it still for a beat where it's caught.\nElite receivers work from the bottom of the zone up: low strikes are the hardest to get called and the most valuable to steal, so they set up so the glove turns over and sticks at the knees rather than dropping below the zone.",
  ...
  // ─── baseball-8-05: Pop Time and Throwing ─────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1999,
      overview: [
        "Pop time is the standard measure of a catcher's throwing on a steal — from the pitch hitting the mitt to the ball reaching the fielder's glove at second base:\n- Elite MLB catchers post around 1.9 seconds; an average big-league time is about 2.0.\n- It combines three things: a fast, clean transfer; quick, efficient footwork; and a strong, accurate arm.\nA catcher with a cannon arm but slow feet and a sloppy transfer will still be slow.",
        ...
        "The transfer — moving the ball from glove to throwing hand into a four-seam grip — must be lightning fast and happen in the center of the body, near the throwing shoulder, not out to the side:\n- A clean transfer with a four-seam grip produces a straight, true throw.\n- A fumbled transfer or poor grip makes the ball sail or tail.\nAccuracy matters as much as velocity: a chest-high throw the fielder can catch and apply in one motion beats a faster throw that pulls them off the base.",
      ],
      technical: {
  ...
  // ─── baseball-8-06: Building the Catcher's Body ───────────────────────────────
  {
    ...
    info: {
      ...
      year: 2010,
      overview: [
        "No position taxes the body like catching — squatting and rising 100-plus times a game, absorbing foul tips, throwing hard from a crouch, every day across a long season. Building a catcher's body has three goals:\n- Generate power — legs, hips, and core for throwing and blocking.\n- Endure the workload — leg and back strength plus mobility.\n- Stay healthy — knee, hip, and shoulder care.\nA strong, mobile, durable body is what lets a catcher's skills show up in the late innings of August.",
        "The foundation is the lower body and core:\n- Strong legs power the throw and hold a stable crouch for nine innings.\n- Mobile hips and ankles allow a deep, balanced squat without straining the knees and back.\n- A strong core transfers energy from the legs to the throwing arm and stabilizes the body during blocks.\n- Posterior-chain strength (glutes, hamstrings, back) protects against the constant flexion of squatting.\nSingle-leg strength and balance work translate directly to throwing footwork.",
  ...
  // ─── baseball-8-08: Plays at the Plate ────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Under current rules, the catcher gives the runner a lane and only blocks once in possession of the ball:\n- Set up giving a lane to the plate — typically up the third-base line or in front, not blocking it.\n- Receive the throw and secure it.\n- Apply a sweep tag — a quick, low tag that catches the sliding runner before they reach the plate.\nBlocking the plate without the ball is now an obstruction violation that can be called safe, so positioning and timing are everything.",
        "The catcher also decides whether it's even a play:\n- On a throw home, read whether the runner can be retired — or concede the run to prevent a trailing runner from advancing.\n- A force play at home (bases loaded) is a tag-free force — step on the plate.\n- A non-force play requires a tag.\nCommunication with the cutoff man and infielders about where the play is — home or elsewhere — happens before the throw even arrives.",
      ],
      technical: {
  ...
  // ─── baseball-8-09: Backups and Coverage ──────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Coverage assignments shift with the situation, and the catcher must know their job before every pitch:\n- Bases empty — back up first base on infield grounders.\n- Runners in scoring position — defend the plate and direct the cutoff.\n- Wild pitch with a runner on third — recover the ball and feed the pitcher covering home.\n- Bunt — field it and call the play.\nMemorizing these until they're automatic is what lets a catcher move the instant the ball is in play, instead of freezing to think.",
      ],
      technical: {
  ...
  // ─── baseball-8-10: Calling the Game and Leadership ───────────────────────────
  {
    ...
    info: {
      ...
      year: 2006,
      overview: [
        "Calling a game is the catcher's mental masterpiece — selecting which pitch to throw and where, on every pitch, to get the hitter out. It accounts for:\n- The hitter's strengths and weaknesses.\n- The count and the game situation.\n- What the pitcher throws well that day.\n- What's already been thrown in the at-bat and the game.\nA great game-caller sequences pitches so each one sets up the next — establishing a fastball to make a changeup deadly, working a weakness, and avoiding predictable patterns the hitter can sit on.",
        "Game-calling rests on preparation:\n- Before the game — study the hitters: who chases breaking balls, who crushes inside fastballs, who can't catch up to velocity up.\n- During the game — learn what's working: if the curveball is sharp today, lean on it; if command is off, simplify.\n- At-bat to at-bat — read each hitter's adjustments, remembering how they were retired or got a hit last time.\nThe plan is a living thing, not a script.",

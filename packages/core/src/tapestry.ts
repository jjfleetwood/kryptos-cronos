...
export const tapestryStages: StageConfig[] = [
  // ─── tapestry-01: What Is Tapestry? ──────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: -1400,
      overview: [
        "Tapestry is one of the oldest art forms on earth — and one of the most misunderstood. True tapestry has a precise definition: a weft-faced weave where the design is formed entirely by the colored weft (horizontal) threads, which completely cover the warp (vertical) threads beneath:\n- The warp is the skeleton — the structural threads, hidden from view.\n- The weft is the painting — the colored threads that carry the entire image.\nThe word is often used loosely for any decorative textile, but this weft-faced structure is what actually makes a tapestry.",
        ...
        "What makes tapestry different from ordinary weaving:\n- In regular cloth, warp and weft appear in equal measure — you see the grid of both.\n- In tapestry, the weft is beaten down so firmly that it completely hides the warp.\n- The weaver works color area by color area, turning back at each boundary, building the image from bottom to top.\nIt's exactly like a painter adding color to a canvas, except the medium is fiber.",
      ],
      technical: {
  ...
  // ─── tapestry-02: Flemish Golden Age ─────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "These were not small workshops — tapestry was a major industry:\n- The great Flemish ateliers employed hundreds of weavers, dye masters, wool merchants, and cartoon painters.\n- A single large tapestry might take a team of weavers several years to complete.\n- Finished pieces were worth more than paintings by the greatest masters of the day.\nThey were the prestige art objects of their time, given as diplomatic gifts between kings and popes.",
        "The design process was elaborate, moving through stages:\n- A painter created a small-scale sketch.\n- It was enlarged to a full-size painting called a 'cartoon' (from the Italian 'cartone,' large paper).\n- The cartoon was placed behind the warp threads; weavers worked from the back, using mirrors or translucent cartoons to follow it.\nThe result, seen from the front, was a mirror-image of the cartoon — which weavers had to account for when the design was asymmetric.",
      ],
      technical: {
  ...
  // ─── tapestry-03: Asian Traditions ───────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 960,
      overview: [
        "While Flemish weavers perfected wool tapestry in Europe, Chinese artisans in the Song dynasty (960–1279 CE) developed 'kesi' — a silk tapestry of breathtaking fineness:\n- The name literally means 'cut silk,' for the small gaps that appear at color boundaries.\n- It was used for imperial robes, scroll paintings, and religious objects.\n- The finest pieces achieve a thread count that makes modern machine-made fabric look coarse.\nWhole silk paintings were reproduced thread by thread in kesi to preserve them.",
        ...
        "Persian tapestry brought different values — bold color, complex geometric and floral patterns, and garden imagery:\n- It depicted the 'paradise garden' (from Old Persian 'pairidaeza,' the root of our word 'paradise') — a walled garden with water channels, flower beds, and birds.\n- These garden tapestries brought the Persian ideal of paradise indoors during the harsh winter months.\n- Their influence spread across the Islamic world, from Turkey to India.\nColor and pattern, not pictorial realism, were the goal.",
      ],
      technical: {
  ...
  // ─── tapestry-04: The Americas ───────────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: -500,
      overview: [
        "Long before European contact, the civilizations of the Andes developed tapestry techniques never surpassed for fineness:\n- Weavers in what is now Peru, Bolivia, and Ecuador achieved weft counts over 100 threads per centimeter, using camelid fibers (alpaca and vicuña) and natural dyes.\n- Textiles were among the most important expressions of social identity, spiritual belief, and political power.\n- The Inca required conquered peoples to contribute textile labor as a form of taxation.\nThese were anything but merely decorative objects.",
        ...
        "Both the Andean and Navajo traditions share important characteristics:\n- Vertical looms.\n- Weft-faced structure.\n- Locally available natural fibers and dyes.\nBoth also treat weaving not as mere craft but as a fundamental cultural act — for the Navajo, a gift from Spider Woman (Ná'ashjé'ii Asdzáá), who taught the first Diné woman to weave on a loom whose warp was made of sky and earth. The technical and the sacred are woven together as inseparably as warp and weft.",
      ],
      technical: {
  ...
  // ─── tapestry-05: Color Theory for Weavers ───────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The basic color wheel applies directly to tapestry:\n- Primaries — red, yellow, and blue.\n- Secondaries — mix two primaries: red + yellow = orange, yellow + blue = green, blue + red = violet.\n- Complementary pairs — a primary with the secondary opposite it (blue/orange, red/green, yellow/violet) seem to vibrate with energy.\nUsed carefully, complementary colors create the most eye-catching tapestries.",
        "Color also carries feeling, and warm and cool behave differently:\n- Warm colors (reds, oranges, yellows) seem to advance — close, energetic, warm.\n- Cool colors (blues, greens, violets) seem to recede — distant, calm, restful.\nUse this deliberately: a warm figure on a cool background always stands out and feels present; a pale cool figure on a warm background can feel mysterious and receding. Every color decision is also a feeling decision.",
      ],
      technical: {
  ...
  // ─── tapestry-06: Warp and Weft ──────────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1662,
      overview: [
        "All weaving — tapestry, cloth, carpet, or canvas — is built from the same simple principle: two sets of threads crossing at right angles:\n- The warp runs up and down (vertically), stretched taut on the loom and held fixed.\n- The weft runs side to side (horizontally), worked in row by row, going over and under alternate warp threads.\nEvery cloth, carpet, and canvas starts from this crossing.",
        "What separates tapestry from ordinary cloth is the balance of the two:\n- In plain-weave cloth, both warp and weft are visible and roughly equal in prominence.\n- In tapestry, the weft is packed down so firmly it buries the warp completely — you see only weft.\nThat's why weavers choose a strong, non-fuzzy yarn for warp (cotton string, linen, or tightly twisted wool) and a softer, more colorful yarn for weft — the warp is an invisible skeleton, the weft carries all the color and image.",
  ...
  // ─── tapestry-07: Your First Loom ────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "That said, there are real differences between loom types that affect the weaving experience:\n- Frame looms — rigid wooden rectangles with pegs or slots; inexpensive, portable, versatile, the ideal starting point.\n- Tapestry looms — larger, often with a built-in shedding device, allowing bigger work and faster progress.\n- High-warp looms — vertical (like those at the Gobelins), letting the weaver see the work from the front while weaving (the traditional European setup).\n- Low-warp looms — horizontal, used in some Flemish traditions, with the weaver working from the back.",
        "For tools, you need relatively little:\n- A tapestry needle — blunt-tipped, with a large eye.\n- A weaving comb or fork — for beating down weft rows.\n- Scissors, and optionally a small stick shuttle for carrying longer lengths of weft.\nEverything else is optional. The Bauhaus weaving workshop — which produced influential textile artists including Anni Albers — began with simple looms and the idea that the most important tool is an educated eye.",
      ],
      technical: {
  ...
  // ─── tapestry-08: Core Techniques ────────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2024,
      overview: [
        "Once you can weave a basic over-under row, every additional technique is a variation on it, each serving a purpose:\n- Hatching — blends colors.\n- Soumak — adds a raised diagonal texture.\n- Interlocking — joins two color areas without a slit.\n- Rya knots — create pile (loops or cut fringe).\nUnderstanding why each technique exists makes learning it much easier.",
        "Slits and joins are one of tapestry's central design challenges:\n- When two color areas meet vertically (both turn back at the same warp thread), a vertical slit — a thin gap — forms between them.\n- Short slits (two or three rows) are structurally fine and are characteristic of Scandinavian tapestry and some Andean traditions.\n- Longer slits weaken the fabric and must be managed — interlocking the weft at the boundary, or sewing the slit closed after completion.\nManaging vertical joins well is a mark of tapestry skill.",
  ...
  // ─── tapestry-09: Pattern and Design ─────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1940,
      overview: [
        "Before you weave a single row, you must decide what you're making — the design phase, where tapestry connects most closely to painting, drawing, graphic design, and photography. It differs from those arts in one key way:\n- You must think in terms of what thread can do.\n- Highly detailed photographic images are difficult.\n- Bold shapes and clear color areas are the language tapestry speaks most fluently.\nDesign to the medium's strengths, not against them.",
        "Begin with a small sketch — even a rough thumbnail shows the main compositional elements. Work from the big picture down:\n- Think about the large shapes first — what are the biggest color areas?\n- Identify the main subject and how large it is relative to the whole.\n- Locate the darkest and lightest areas.\nSimple designs with three to five distinct color areas are ideal for beginners, and geometric patterns — diamonds, stripes, chevrons — make excellent first projects because the shapes and color areas are clear.",
  ...
  // ─── tapestry-10: Optical Color Mixing ───────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1886,
      overview: [
        "One of tapestry's most magical properties is optical color mixing — separate threads of different colors, seen from a slight distance, merge in the eye into new colors and tones:\n- It's the same phenomenon the Impressionist painters discovered in the 1880s.\n- Georges Seurat's Pointillism placed pure dots of color side by side, knowing the eye would mix them.\n- In tapestry, the weft threads are the dots, and the 'mix' happens automatically with distance.\nDistance, not the palette, does the blending.",
        "Optical mixing in tapestry works in three main ways:\n- Blended yarn — two colors twisted or held together in the needle, entering the weave side by side.\n- Hatching — alternating rows or wedges of different colors that blend at a distance.\n- The 'bouclé' or textural approach — different-colored threads in adjacent rows creating a heathered, blended surface.\nAll three produce different visual textures and suit different parts of a design.",
  ...
  // ─── tapestry-11: Contemporary Practice ──────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Contemporary tapestry artists work in a huge range of styles:\n- Archie Brennan (1931–2019, Scottish) kept a close connection to traditional Gobelin high-warp technique while exploring deeply contemporary subjects.\n- Rebecca Mezoff (American) made tapestry instruction her life's work, transforming how people learn to weave.\n- Others use tapestry as raw material for installation art, sculpture, and social practice.\nThe medium now sits in major galleries and museums alongside painting and sculpture.",
        "The materials of contemporary tapestry are more diverse than ever:\n- Traditional wool and silk remain central.\n- Weavers now incorporate cotton, linen, recycled materials, wire, paper yarn, bamboo, and even found objects.\n- Scale ranges from wall-filling installations to miniatures a few inches across.\nThe shared element is always the warp-and-weft structure — over-under, thread by thread — that connects every contemporary weaver to those Egyptian artisans of 1400 BCE.",
      ],
      technical: {
  ...
  // ─── tapestry-12: Your First Tapestry ────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2024,
      overview: [
        "Everything you've learned comes together in weaving your first tapestry — you already have all the knowledge you need:\n- You understand warp and weft.\n- You know how to read a cartoon and transfer it to the loom.\n- You can mix colors optically, change colors cleanly, and manage simple joins.\n- You know hatching for gradients and soumak for texture.\nThe only thing left is to begin.",
        "For your first tapestry, keep it beautifully simple:\n- About 15 × 20 cm (6 × 8 inches).\n- Three to five colors.\n- A clear horizontal design — a simple landscape, an abstract geometric pattern, or just beautiful stripes in shades you love.\nThe goal isn't a masterwork; it's to finish it, feel the texture of the finished cloth, understand how warp and weft interact in practice rather than theory, and experience the quiet, absorbing pleasure of building an image thread by thread.",

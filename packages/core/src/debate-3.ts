...
export const debate3Stages: StageConfig[] = [
  ...
  // ─── debate-3-02: Lincoln-Douglas ─────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The defining structure of LD is the value and criterion (the framework). Each debater proposes two things:\n- A core value the round should be judged by — justice, morality, autonomy, social welfare.\n- A criterion — a standard for achieving or measuring that value, like maximizing well-being, protecting rights, or the categorical imperative.\nWhoever wins the framework debate controls how every other argument is weighed: arguments serving the winning value/criterion matter; those that don't are filtered out. This is why LD debaters study moral philosophy — Kant, Mill, Rawls, social contract theory — as the architecture of their cases.",
        "LD has six speeches and two cross-examinations, all delivered solo (no partner):\n- The Affirmative speaks first and last but has less total speaking time.\n- The Negative gets a long middle speech to both rebuild and attack.\nBecause one person does everything — case, cross-ex, rebuttals, weighing — LD rewards versatility and deep individual mastery. Its culture varies: some circuits prize accessible, persuasive philosophy for lay judges, while the national circuit runs faster, more technical, theory-laden styles. At its best, LD most directly trains rigorous ethical argument.",
      ],
      technical: {
  ...
  // ─── debate-3-03: Public Forum ────────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "PF's signature element is crossfire — open, three-minute periods where debaters question each other directly (not one-way cross-examination):\n- A crossfire after the first two speeches.\n- Another after the next two.\n- A 'grand crossfire' with all four debaters near the end.\nCrossfire rewards quick thinking, composure, and exposing weaknesses conversationally. The short speeches, monthly topics, and lay-judge norm keep the round nimble and grounded — a PF debater who spreads or buries the round in jargon usually loses.",
        "Because topics rotate monthly and judges are often non-specialists, PF rewards a distinct skill set:\n- Efficient research on current events.\n- Clean, persuasive delivery.\n- Sharp crossfire.\n- Distilling complex issues into accessible, well-weighed arguments.\nThe final speeches (the 'Final Focus') crystallize the two or three best reasons your side wins. PF is the most popular U.S. high-school format precisely because it's approachable, current, and transferable — building the public-persuasion skills useful in careers from business to journalism to public life.",
      ],
      technical: {
  ...
  // ─── debate-3-04: Parliamentary Debate ────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1991,
      overview: [
        "Parliamentary debate ('parli'), modeled on the British House of Commons, strips away the evidence files and tests reasoning on your feet:\n- Two teams — Government (proposes and defends the motion) and Opposition (attacks it).\n- Limited preparation — in American collegiate styles like NPDA, teams get the motion and only about 15–20 minutes to prep.\n- No cards to read — arguments are built live from the debater's own knowledge, logic, and persuasion.\nThis makes parli a test of broad general knowledge, analytical reasoning, and rhetorical agility rather than research depth.",
        ...
        "Because there's little prep and no evidence, parli rewards a distinct skill set:\n- A wide base of general knowledge across politics, history, economics, ethics, and current affairs.\n- The ability to structure a coherent case in minutes.\n- Clear, persuasive extemporaneous speaking.\n- Adaptability to motions you've never seen.\nStyles vary by circuit — NPDA and APDA in the U.S. each have their own conventions. Parli is excellent training for thinking and speaking under pressure, which is precisely why it resembles the real legislative debate it's modeled on.",
      ],
      technical: {
  ...
  // ─── debate-3-05: British Parliamentary / Worlds ──────────────────────────────
  {
    ...
    info: {
      ...
      year: 1981,
      overview: [
        "British Parliamentary (BP) is the format of the World Universities Debating Championship (WUDC) — the closest thing debate has to a global standard. Its defining feature is four two-person teams in a single round, not two:\n- Opening Government and Closing Government on the Proposition side.\n- Opening Opposition and Closing Opposition on the Opposition side.\nThat's eight speakers total, split into 'Opening' and 'Closing' halves, and the judges rank all four teams from 1st to 4th.",
        ...
        "BP uses limited prep (typically 15 minutes), motions spanning policy, values, and international affairs, and Points of Information across teams. Its demands make it one of the most strategically complex formats:\n- Clash with your opponents.\n- Differentiate from your allies on the same bench.\n- Extend the debate with fresh, substantive argument late.\n- Do it all on limited prep before international judges.\nBecause it's the global university format, BP connects debaters across countries and cultures, and WUDC crowns world champions annually.",
      ],
      technical: {
  ...
  // ─── debate-3-06: World Schools ───────────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1988,
      overview: [
        "World Schools Debate (WSD), the format of the World Schools Debating Championships, is designed to balance the strengths of British and American styles:\n- Two three-person teams — Proposition and Opposition.\n- Motions that mix prepared (announced in advance, allowing research) and impromptu (given with about an hour of prep, no internet).\n- Topics spanning policy, values, and international affairs, often phrased 'This House would…' or 'This House believes…'.\nThe blend deliberately tests both deep preparation and on-your-feet reasoning, rather than specializing in one.",
        "WSD's distinctive feature is its explicit three-pillar judging — every speech is scored on:\n- Style — delivery, clarity, persuasiveness, engagement.\n- Content — the quality, logic, and evidence of arguments.\n- Strategy — structure, prioritization, responsiveness, and navigating the clash.\nUnlike formats that reward technical coverage or speed, the balanced rubric means you can't win on substance alone with poor delivery, or on charisma alone with weak arguments. The best WSD debaters are genuinely well-rounded.",
  ...
  // ─── debate-3-07: Congressional Debate ────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Speeches alternate between affirmation and negation of the bill under consideration, and after each, members may rise for questioning (cross-examination of the speaker by the chamber):\n- The first speech on a bill (the 'authorship' or sponsorship speech) introduces it and is purely constructive.\n- Later speeches must engage the arguments already made — refuting prior speakers and advancing new points.\nSo a great Congress debater is also a great listener who adapts to the flow of chamber debate, and speakers are ranked by judges (and sometimes peers) on argumentation, delivery, and engagement.",
        "Congress runs on parliamentary procedure, presided over by a student Presiding Officer (PO) — itself a competitive role — using rules derived from Robert's Rules of Order. Success requires versatility:\n- Research across many docket topics (you don't know which bills will come up).\n- Strong extemporaneous and prepared speaking.\n- Strategic timing of when to speak (early speeches frame; late speeches must add new clash).\n- The procedural savvy to navigate or preside over the chamber.\nIt's the format that most directly trains the skills of actual legislative debate and public deliberation.",
      ],
      technical: {
  ...
  // ─── debate-3-08: Mock Trial and Moot Court ───────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1820,
      overview: [
        "Mock trial and moot court simulate the legal system rather than open debate, sharing debate's core skills while adding the constraints of law. In mock trial, teams act as prosecution/plaintiff and defense in a simulated jury trial:\n- Students play attorneys — delivering opening statements, conducting direct and cross-examinations of witnesses, and giving closing arguments.\n- Others play witnesses — testifying in character, staying within a sworn affidavit.\nThe case packet (facts, witness statements, exhibits, applicable law) is fixed and given to both sides, so the contest is purely about advocacy, not who has better facts.",
        ...
        "What distinguishes legal advocacy from open debate is the framework of rules:\n- In mock trial, the rules of evidence govern what can be said — you must object to improper questions ('Objection — hearsay,' 'leading the witness,' 'speculation') in real time, and a judge rules on the spot.\n- In moot court, you're bound by precedent and the standard of review — you can't simply argue what's fair, you must argue what the law requires.\nThese constraints teach a discipline open debate doesn't: persuading within a rule-bound system, which is exactly the skill of a practicing lawyer.",
      ],
      technical: {
  ...
  // ─── debate-3-09: Extemporaneous and Impromptu Speaking ───────────────────────
  {
    ...
    info: {
      ...
      year: 1874,
      overview: [
        "Extemporaneous speaking ('extemp') and impromptu are individual speech events that sharpen debate's reasoning and delivery under time pressure, without an opponent. Extemp works like this:\n- Draw a question about current events (e.g., 'Will the EU's new policy strengthen the euro?').\n- Get roughly 30 minutes to prepare a structured 7-minute speech, using a limited file of articles.\n- Take a position, support it with evidence and reasoning, and deliver it fluently — alone, with no rebuttal to lean on.\nIt's debate's research-and-analysis muscle isolated.",
        ...
        "Both events reinforce skills that transfer directly to debate:\n- Extemp builds rapid current-events analysis, evidence integration, and the discipline of answering a precise question — invaluable for Public Forum and parliamentary debaters.\n- Impromptu builds the instinct to structure thought instantly and speak without notes — invaluable for cross-examination, points of information, and any moment a round goes off-script.\nMany of the best debaters compete in extemp or impromptu alongside debate precisely because they train the spontaneity, organization, and fluency that no pre-written casework can provide.",
      ],
      technical: {
        title: "The Extemp Speech Structure and the Impromptu Sprint",
        body: [
          "Extemp speeches follow a tight, recognizable structure that a debater can build in 30 minutes:\n- an attention-getting introduction that links to the question\n- a clear thesis directly answering the drawn question\n- two or three substantive points each supported with current evidence and analysis\n- signposted transitions\n- a conclusion that ties back to the introduction\nThe discipline is answering the actual question asked — a brilliant speech that drifts off the precise question is penalized, just as a debate response that doesn't address the actual argument floats free of the flow. Time management in prep (research fast, outline, rehearse the intro) is the core craft.",
  ...
  // ─── debate-3-10: Choosing Your Format ────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2024,
      overview: [
        "With so many formats, the honest answer to 'which one?' is that it depends on your strengths, goals, and what's available:\n- Love deep research and technical precision? Policy.\n- Drawn to philosophy and ethics, and like competing solo? Lincoln-Douglas.\n- Want accessible, persuasive debate on current events? Public Forum.\n- Think fast with broad knowledge but dislike research files? Parliamentary or British Parliamentary.\n- Want a balanced, international format? World Schools.\n- Fascinated by government and procedure? Congress.\n- Aiming at law? Mock trial or moot court.\nThe right choice aligns the format's demands with what you enjoy and want to develop.",
        "Practical factors matter as much as temperament:\n- Availability is decisive — the best format is one you can actually compete in, with a coach, teammates, and reachable tournaments.\n- Time commitment varies — policy's year-long research is a heavy investment; Public Forum's monthly topics are lighter.\n- Partner vs. solo is a real preference — PF, policy, and World Schools are team formats; LD is solo; Congress is individual-in-a-group.\n- Goals shape the choice — a future lawyer might prioritize mock trial; someone seeking broad communication skills, Public Forum or World Schools; an aspiring policy analyst, policy or Congress.",
      ...
      technical: {
        ...
        body: [
          "To choose, weigh four factors. (1) Temperament/strengths:\n- research depth (policy)\n- philosophy and solo competition (LD)\n- persuasion and current events (PF)\n- improvisation and breadth (parli/BP)\n- balance (World Schools)\n- procedure and government (Congress)\n- legal advocacy (mock trial/moot court)\n(2) Goals: what skills or career are you building toward? (3) Logistics: what does your program offer, who can coach you, and what tournaments can you attend? (4) Commitment: how much research time can you give? No factor alone decides — the best fit usually satisfies several, especially availability, since a format you can't actually compete in helps no one.",

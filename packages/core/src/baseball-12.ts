...
export const baseball12Stages: StageConfig[] = [
  // ─── baseball-12-01: The Captain of the Infield ───────────────────────────────
  {
    ...
    info: {
      ...
      year: 1978,
      overview: [
        "Shortstop is widely considered the most demanding position on the infield and one of the most important on the field. The shortstop covers more ground than any other infielder — ranging deep into the hole toward third, up the middle behind second base, and everywhere between — and makes the longest, hardest infield throws, especially from deep in the hole. The position demands the best all-around defensive tools: range, soft hands, a strong and accurate arm, footwork, and the athleticism to make plays on the move from any position.",
        "Beyond physical tools, the shortstop is the captain of the infield — and often the leader of the entire defense. The shortstop positions teammates, directs cutoffs and relays, communicates coverage with the second baseman, and takes charge on every play. Because the position requires the most talent and the most awareness, the best athlete with the strongest leadership often plays shortstop. Teams build their defense around a great shortstop the way they build around a great pitcher.",
        "The shortstop's signature plays — the deep-hole backhand and throw, the jump or leaping throw, the double-play pivot, and the charging barehand on slow rollers — are among the most spectacular and difficult in the game. Ozzie Smith, 'The Wizard,' turned the position into an art form with his range, acrobatics, and leadership. This epoch builds the complete shortstop: the range and arm to cover the middle and make the impossible throw, and the intelligence and leadership to captain the defense.",
      ],
      technical: {
  ...
  // ─── baseball-12-02: Positioning and the Ready Position ───────────────────────
  {
    ...
    info: {
      ...
      technical: {
        ...
        body: [
          "Depth by situation: play normal depth for the best overall range; double-play depth (in and toward second) with a runner on first and a double play needed; infield in to cut down a run at the plate; adjust laterally for the hitter's tendencies, power, and speed. Because the shortstop covers the most ground, optimal positioning is especially valuable.",
  ...
  // ─── baseball-12-03: Fielding and Footwork ────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1996,
      overview: [
        "The shortstop fields more ground balls over more territory than any infielder, so the fundamentals of fielding and footwork are the foundation of the position. The basics match all infielders: an explosive first step from the ready position, an efficient route to the ball, fielding it out in front with the glove down and fingers at the ground, watching it into the glove, and using two hands when possible. But the shortstop must do this while ranging farther and throwing from more difficult positions than anyone else, so footwork and body control are paramount.",
        "Range to both sides defines the shortstop. To the glove side (into the hole toward third), the shortstop uses a crossover step and often a backhand. Up the middle (to the second-base side), he ranges to his left, fields, and must organize his feet to throw from deep. On routine balls, he wants to field the ball moving toward first base so his momentum carries into the throw — 'rounding off' the ball and fielding it on the correct foot. The shorter the time, the more the shortstop must field and throw in rhythm rather than fielding flat-footed and resetting.",
  ...
  // ─── baseball-12-04: The Deep Hole and the Jump Throw ─────────────────────────
  {
    ...
    info: {
      ...
      year: 1996,
      overview: [
        "The signature play of a shortstop is the ball deep in the hole toward third base. The shortstop ranges far to his right, fields the ball on the backhand at full extension, and must then make the longest, hardest throw on the infield — all the way across the diamond to first — while his momentum is carrying him away from the target. This play combines elite range, soft backhand hands, and a powerful, accurate arm, and it's why shortstops need the best all-around tools.",
        "There are two main ways to make the throw from the deep hole. The classic is the plant-and-throw: after backhanding the ball, the shortstop plants hard on his right foot to stop his momentum and create a base to throw from, then fires across his body to first. The other is the jump throw (or leaping throw): on balls hit so hard and deep that there's no time to plant, the shortstop catches the ball and throws while leaping and turning in the air, using the momentum of the jump to generate arm strength. Derek Jeter made the jump throw from the hole famous.",
  ...
  // ─── baseball-12-05: Building the Shortstop's Body ────────────────────────────
  {
    ...
    info: {
      ...
      year: 2013,
      overview: [
        "Shortstop requires the most complete physical package of any infield position. Because the shortstop covers the most ground, makes the hardest throws, and must field and throw from every conceivable position, the position demands a blend of range (lateral quickness and first-step explosiveness), arm strength (for the longest, hardest infield throws), agility and body control (to field on the move and throw from off-balance positions), and overall athleticism. Where other infield positions can lean on one or two standout tools, shortstop needs them all.",
        "Range and quickness come first. Lateral quickness, first-step explosiveness, and change-of-direction agility — built through reaction drills, lateral movement work, and footwork training — create the range the position demands. Single-leg strength and balance are essential for fielding and throwing from off-balance positions, planting in the hole, and the jump throw. Strong legs and a powerful core power the explosive first step and the throws. The shortstop is fundamentally a quick, agile, explosive athlete.",
  ...
  // ─── baseball-12-06: Turning the Double Play ──────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1985,
      overview: [
        "The shortstop is the other half of the keystone combination, and double plays run through him just as they do the second baseman. On a ground ball to the right side (to the second baseman), the shortstop covers second base and becomes the pivot man, receiving the feed, touching the bag for the force, and relaying to first to complete a 4-6-3 double play — all while clearing a sliding runner. On a ground ball to the left side (to the shortstop himself or the third baseman), the shortstop fields or covers and feeds the second baseman for a 6-4-3.",
        ...
        "When the shortstop is the feeder, the same principles apply as for the second baseman's feed: deliver a catchable, turnable ball to the second baseman covering, choosing the feed by distance (underhand toss close to the bag, backhand flip, or firmer throw from deep). Whether feeding or pivoting, the shortstop must protect himself with a quick release and footwork that clears the runner, especially under the modern slide rule. The double play is a partnership, and the shortstop's half of it is as essential as the second baseman's.",
      ],
      technical: {
  ...
  // ─── baseball-12-07: Charging Slow Rollers ────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The technique mirrors the do-or-die play: charge under control, circle the ball slightly so momentum carries toward first, field with the glove on a moving ball or barehand a ball that's nearly stopped (a glove can't pick a dead ball quickly enough), and time the pickup with the throwing-side foot so fielding and throwing flow in rhythm. The throw is made on the run, often sidearm, prioritizing a quick release and accuracy over power because the play is a race.",
  ...
  // ─── baseball-12-08: Relays, Cutoffs, and Leadership ──────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Being a good relay man means getting to the right spot quickly, giving the outfielder a clear target, catching the throw on the glove side while turning toward the infield, and making a strong, accurate relay to the target base. As the trailing infielder, the shortstop lines up the relay man and calls the target ('two!', 'three!', 'home!', 'cut!'). On many cutoff plays, the shortstop is also the captain who reads the whole play and directs where the throw should go, because his view and leadership make him the natural decision-maker.",
        "The shortstop's leadership extends across the entire throwing game and defense. He directs cutoffs and relays, coordinates coverage with the second baseman, positions teammates, and backs up bases when not the relay man. As the captain, he often makes or relays the key decisions on where throws go. Knowing his assignment — relay man, trailer, cutoff director, or backup — before each pitch, and leading the defense's execution, is a defining part of the shortstop's role. He's the hub that connects the outfield and infield into one coordinated defense.",
      ],
      technical: {
  ...
  // ─── baseball-12-09: Situational IQ ───────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2000,
      overview: [
        "As the captain, the shortstop must process the situation for himself and the whole defense before each pitch. The key reads: outs, runners and their speed, whether a double play is on, coverage responsibilities with the second baseman (who covers second on a steal), and what to do with the ball if it's hit to him — turn two, take the sure out, get the lead runner, or make a play at the plate with the infield in. Because he's also leading the defense, he must know the whole infield's positioning and assignments, not just his own.",
        "Coverage and double-play decisions are central. The shortstop and second baseman pre-decide who covers second on a steal, usually by the batter's handedness — conventionally, the shortstop covers second against a right-handed batter (the second baseman shades to field a pulled grounder), and the second baseman covers against a left-handed batter. On a ground ball with a runner on first, the shortstop decides whether to turn two or take the sure out, factoring the ball's speed and the runners' speed. With the infield in, he prioritizes cutting down the run at the plate.",
  ...
  // ─── baseball-12-10: The Greats and Mastery ───────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2002,
      overview: [
        "The greatest shortstops share a complete set of pursuable traits: elite range and soft, quick hands; a strong, accurate arm for the deep-hole and jump throws; the agility and body control to field and throw from any position; the footwork to charge, backhand, and turn the double play; the improvisation to make plays on bad hops; and the leadership and baseball IQ to captain the defense. Ozzie Smith embodied all of it with a wizardry that made the position an art — but the qualities, not the highlights, are what to study and build.",

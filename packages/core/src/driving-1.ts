...
export const driving1Stages: StageConfig[] = [
  // ─── driving-1-01: The Path to Your Permit ────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1913,
      overview: [
        "California requires any new driver under 18 to obtain an instruction permit before practicing behind the wheel. The minimum age to apply is 15 years and 6 months — not 16. This half-year distinction surprises many applicants. To apply, you must visit a DMV office in person and bring:\n- Proof of identity (birth certificate or passport).\n- Proof of California residency.\n- Your Social Security number.\n- If you are under 18, a signed Parental Consent (DL 44C) form from a parent or legal guardian.",
        "At the DMV, you will:\n- Pay the application fee (currently $39 for a non-commercial instruction permit).\n- Have your vision tested.\n- Take the written knowledge test.\nIf you pass (38 out of 46 questions correct), you are issued a temporary instruction permit on the spot. The official plastic permit card arrives by mail within a few weeks.",
  ...
  // ─── driving-1-02: Ace the Written Test ──────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1927,
      overview: [
        "The California DMV written knowledge test is straightforward if you study:\n- 46 multiple-choice questions; you must answer at least 38 correctly — a score of 82.6%.\n- Questions are drawn directly from the California Driver Handbook (free from the DMV website or any DMV office).\n- There are no trick questions — all the answers are in the handbook.\nIf you study the handbook, you will pass.",
        ...
        "Study strategy is simple and reliable:\n- Read the handbook cover to cover at least once, paying particular attention to speed limits, right-of-way rules, signal distances, and the graduated-license rules for teen drivers.\n- Take as many practice tests as possible using DMV-approved materials.\n- Focus extra study time on the areas where you make the most mistakes.\nMethodical study of the handbook plus practice tests is the whole formula.",
      ],
      technical: {
  ...
  // ─── driving-1-03: Road Signs Part 1 ─────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The STOP sign is a red octagon — eight sides, always red:\n- Come to a complete stop at the limit line, crosswalk, or the edge of the intersection if there's no line.\n- 'Rolling through' (a 'California stop' or 'rolling stop') is illegal and one of the most commonly cited moving violations.\n- After stopping, yield to all traffic and pedestrians before proceeding.",
        "Two more key regulatory signs:\n- YIELD — a downward-pointing red-and-white triangle; slow down and give the right of way to traffic already in the intersection or roadway, stopping only if traffic requires it.\n- Speed limit — white rectangles with black text showing the maximum under ideal conditions; the Basic Speed Law means you must slow below posted limits whenever conditions (weather, traffic, visibility) are unsafe.",
      ],
      technical: {
  ...
  // ─── driving-1-04: Road Signs Part 2 ─────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Guide signs provide directional and informational guidance, color-coded:\n- Green rectangular — highway route numbers, destinations, and distances.\n- Blue — motorist services (gas, food, lodging, hospitals).\n- Brown — recreational areas, parks, and historic sites.\nThey help you navigate but impose no legal requirements.",
        "Two special sign types carry hard rules:\n- School zone — fluorescent yellow-green pentagonal (five-sided) signs; when the flashing light is active OR children are present, the limit drops to 25 mph regardless of the normally posted limit.\n- Railroad crossing — the round yellow advance-warning sign (X and two Rs), the white crossbuck at the crossing, and flashing red lights; when lights flash or gates lower, stop at least 15 feet from the nearest rail.\nWarning signs themselves (yellow diamonds) advise caution but don't require a stop.",
      ],
      technical: {
  ...
  // ─── driving-1-05: Speed Laws and Space ──────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1959,
      overview: [
        "California has two complementary speed laws:\n- Absolute Speed Limit Law — you may not exceed the posted limit (the number on the white sign) under any circumstances.\n- Basic Speed Law (Vehicle Code 22350) — you may never drive faster than is safe for current conditions, regardless of the posted limit.\nIn fog, rain, heavy traffic, or on a slippery road you may need to drive well below the posted limit — and you can be cited under the Basic Speed Law even below the posted limit if conditions made your speed unsafe.",
        "California's prima facie (default) speed limits apply when no other limit is posted:\n- 15 mph — railroad crossings without gates or signals, and alleys.\n- 25 mph — residential districts, and school zones during school hours.\n- 55 mph — undivided two-lane highways.\n- 65 mph — most freeways (70 where specifically posted).\nKnowing the defaults matters where no sign is present.",
  ...
  // ─── driving-1-06: Right of Way ───────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The order at intersections follows clear rules:\n- 4-way stop — vehicles proceed in the order they arrived.\n- Tie at a 4-way — the vehicle on the left yields to the vehicle on the right (look right; if a car's there, yield); the same applies if three or four arrive at once.\n- Uncontrolled intersection (no signs or signals) — yield to traffic already in the intersection and to vehicles approaching from the right.\nThese resolve nearly every who-goes-first situation.",
        "Pedestrians and emergency vehicles take priority:\n- Pedestrians have the right of way in marked crosswalks — yield when one is in or entering it.\n- Pedestrians also have the right of way in unmarked crosswalks at intersections.\n- For an emergency vehicle with lights and siren, immediately pull to the right edge and stop until it passes (on a one-way street, pull to the nearest edge).\nRemember the principle: right of way is given, not taken — yield to avoid a collision even when it's technically yours.",
      ],
      technical: {
  ...
  // ─── driving-1-07: DUI Laws and Teen Restrictions ────────────────────────────
  {
    ...
    info: {
      ...
      year: 1990,
      overview: [
        "California's DUI laws have key BAC thresholds:\n- 21 and older — illegal to drive at 0.08% BAC or higher (a DUI, Driving Under the Influence).\n- Under 21 — zero tolerance: any measurable alcohol (0.01% or higher) results in automatic license suspension; a single drink can trigger it.\n- Commercial drivers — the limit is 0.04% BAC.\nThe age-based difference is a frequent test point.",
        "Teen drivers with a provisional license (at age 16, after 6 months holding a permit and 50 hours of practice) face extra restrictions for the first 12 months or until they turn 18, whichever is later:\n- No driving between 11 PM and 5 AM.\n- No carrying passengers under 20 — unless a licensed driver age 25 or older, or a parent, guardian, or licensed adult relative, is in the vehicle.\nThese provisional-period rules are heavily tested.",
  ...
  // ─── driving-1-08: The Behind-the-Wheel Test ─────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The scoring distinguishes two kinds of error:\n- Critical errors (immediate failure) — running a red light, failing to yield to a pedestrian, requiring the examiner to take physical control, going the wrong way on a one-way street, or significantly exceeding the speed limit; any one fails you regardless of the rest.\n- Minor errors (point deductions) — these accumulate, and more than 15 is also a failing score.\nOne critical error ends the test, so safety fundamentals come first.",
        "What examiners look for on every maneuver:\n- Checking mirrors before and after actions.\n- Signaling at least 100 feet before turns.\n- Smooth, gradual braking — not abrupt stops.\n- Maintaining proper lane position.\n- Correctly identifying and yielding at stop signs and signals, at appropriate speed for conditions.\nThe most common reasons for failure are not checking mirrors, rolling stops, and not looking before changing lanes.",
      ],
      technical: {

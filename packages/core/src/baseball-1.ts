...
export const baseball1Stages: StageConfig[] = [
  // ─── baseball-1-01: The Field and the Game ────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "A team fields nine players, each in a specific position:\n- Pitcher (1)\n- Catcher (2)\n- First baseman (3)\n- Second baseman (4)\n- Third baseman (5)\n- Shortstop (6)\n- Left fielder (7)\n- Center fielder (8)\n- Right fielder (9)\nThese numbers are used on scorecards and in scoring (e.g., a 6-4-3 double play means shortstop to second baseman to first baseman).",
  ...
  // ─── baseball-1-02: Rules Every Player Must Know ──────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The infield fly rule is one of baseball's most misunderstood rules. It applies when all of these are true:\n- Runners on first and second, or bases loaded.\n- Fewer than two outs.\n- A fair fly ball is hit to the infield that an infielder can catch with ordinary effort.\nIn this situation, the batter is automatically declared out — even if the fielder drops it intentionally. This rule exists to prevent fielders from deliberately dropping easy pop-ups to create a cheap double or triple play.",
      ],
      technical: {
  ...
  // ─── baseball-1-03: The Art of Batting ────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The swing is a sequence:\n- Load — shift weight to back foot, hands move slightly back.\n- Stride — small step toward the pitcher with the front foot (just a few inches, keeping the front foot closed).\n- Hip rotation — hips fire toward the pitcher, generating power.\n- Contact — arms extend, hands stay through the ball.\n- Follow-through — the bat continues all the way around to the back shoulder.\nThe most common mistakes: stepping in the bucket (front foot steps away from the plate rather than toward the pitcher), dropping the back elbow, and lifting the head before contact.",
      ],
      technical: {
  ...
  // ─── baseball-1-04: Pitching Fundamentals ─────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Pitching mechanics sequence:\n- start with a balanced stance on the rubber\n- begin the windup\n- stride forward toward home plate with the front foot (stride length approximately 80–90% of height for most pitchers)\n- rotate the hips and shoulders\n- release the ball with the arm traveling in a natural arc\n- follow through completely — the arm should finish on the glove-side thigh\nIncomplete follow-through is a major cause of arm stress.",
      ],
      technical: {
        title: "Little League Pitch Count and Rest Requirements",
        body: [
          "Little League Baseball has strict pitch count rules designed to protect young arms. The limits depend on age:\n- Ages 7–8: max 50 pitches/day.\n- Ages 9–10: max 75 pitches/day.\n- Ages 11–12: max 85 pitches/day.\n- Ages 13–16: max 95 pitches/day.\n- Ages 17–18: max 105 pitches/day.\nThese are maximums — coaches should monitor arm fatigue regardless of the count.",
  ...
  // ─── baseball-1-05: Fielding and Throwing ─────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1960,
      overview: [
        "Defense in baseball begins before the ball is pitched. A fielder in the correct ready position — athletic stance, glove out and ready, on the balls of their feet — can react to any ball faster and more cleanly than one who is caught flat-footed. The ready position is:\n- feet slightly wider than shoulder-width\n- knees bent\n- weight forward on the balls of the feet\n- glove at waist height in front of the body\n- eyes up and tracking the batter",
        "Fielding ground balls requires approaching the ball rather than waiting for it to arrive. The technique:\n- Charge forward to take the ball out front — don't let it play you.\n- Get the body low, back parallel to the ground.\n- Place the glove down with fingers pointing at the ground (prevents short-hops bouncing over the glove).\n- Watch the ball into the glove.\n- Field with both hands — the throwing hand closes over the ball in the glove.\nThe common mistake: straightening up too early and trying to field at hip height — balls go through the legs.",
        "Throwing mechanics:\n- grip the ball with a four-seam fastball grip across the seams (straight, accurate throw)\n- align the front shoulder toward the target\n- step with the front foot toward the throw\n- rotate hips and shoulders\n- extend the arm naturally\n- follow through\nThe accuracy of a throw comes from consistent grip and front shoulder alignment.",
      ],
      technical: {
  ...
  // ─── baseball-1-06: Infield Play ──────────────────────────────────────────────
  {
    ...
    info: {
      ...
      technical: {
        ...
        body: [
          "For the second baseman receiving a throw at second base (the 4 in a 6-4-3):\n- Catch the ball.\n- Drag the back foot across the bag while throwing (or touch with the foot just before catching).\n- Clear away from the base path to avoid the runner.\nThe key is catching the ball first, then making the throw — never rush the transfer so badly that both plays are missed.",
  ...
  // ─── baseball-1-07: Outfield Play ─────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The drop step is the foundational technique for balls hit over an outfielder's head. When you see the ball going back:\n- Pivot on the foot nearest the direction the ball is going — drop that foot behind you.\n- Turn your body.\n- Sprint at full speed to the landing spot — never backpedal.\nThe drop step gets you to full sprint speed in two steps rather than several shuffling steps backward.",
  ...
  // ─── baseball-1-08: Baserunning ────────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The third base coach is the player's eyes when running between second and third, and from third toward home. The coach uses signals:\n- Hands raised — stop.\n- Arm waving in circles — go.\n- Hands patting down — slide.\n- Hands across the body — stop.\nOn contact, the base runner's job is to run hard and read the coach — not to make the decision themselves. Trust the coach. They have the view; you don't.",
      ],
      technical: {
  ...
  // ─── baseball-1-09: Catching ──────────────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1950,
      overview: [
        "The catcher is the most physically demanding and strategically demanding position in baseball. They wear more equipment than any other player:\n- A chest protector.\n- A helmet with a face guard (skull cap or helmet).\n- Shin guards.\n- A cup (required for male catchers).\nThe equipment protects from foul tips, wild pitches, and collisions at the plate. The catcher is the only fielder who faces the entire field throughout the game.",
    ...
    info: {
      ...
      technical: {
        ...
        body: [
          ...
          "What good teammates do after a teammate's error:\n- Say nothing about the error in the moment.\n- Encourage the next play ('shake it off, you got the next one').\n- Remember that errors are part of the game — every player at every level makes them.\nWhat great teammates do after their own error: take a breath, refocus, and make the next play harder. Great teammates are remembered for their character, not their statistics.",
        ],
        codeExample: {

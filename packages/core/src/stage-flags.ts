...
export const stageFlags: Record<string, string> = {
  ...
  "recon-01": "FLAG{NMAP_SYN_SC4N_0P3N_P0RTS}",
  "recon-02": "FLAG{S3RV1C3_V3RS10N_3NUM3R4T3D}",
  "recon-03": "FLAG{NSE_VULN_SCR1PT_M4TCH}",
  "recon-04": "FLAG{D1R_BUST_H1DD3N_4DM1N}",
  "web-01": "FLAG{SQL1_UN10N_DUMP3D_DB}",
  "web-02": "FLAG{BURP_T4MP3R_4UTH_BYP4SS}",
  "web-03": "FLAG{XSS_C00K13_3XF1LTR4T3D}",
  "web-04": "FLAG{LF1_T0_RC3_PWN3D}",
  "pw-01": "FLAG{HYDR4_SSH_BRUT3_F0RC3D}",
  "pw-02": "FLAG{H4SHC4T_NTLM_CR4CK3D}",
  "pw-03": "FLAG{RUL3S_M4NGL3_W34K_P4SS}",
  "pw-04": "FLAG{SPR4Y_STUFF_PTH_PWN3D}",
  "pe-01": "FLAG{SU1D_SUD0_R00T_3SC4L4T3D}",
  "pe-02": "FLAG{L1NP34S_CR0N_M1SC0NF1G}",
  "pe-03": "FLAG{W1N_T0K3N_SYST3M_PWN3D}",
  "pe-04": "FLAG{P3RS1ST_CR0N_K3Y_PL4NT3D}",
  "cap-01": "FLAG{3NG4G3M3NT_SC0P3_R3C0N}",
  "cap-02": "FLAG{F00TH0LD_W3BSH3LL_G41N3D}",
  "cap-03": "FLAG{R00T_P1V0T_1NT3RN4L}",
  "cap-04": "FLAG{D0M41N_4DM1N_R3P0RT_D0N3}",
  "traf-01": "FLAG{W1R3SH4RK_CL34RT3XT_CR3DS}",
  "traf-02": "FLAG{TCPDUMP_BPF_C4PTUR3D}",
  "traf-03": "FLAG{4RP_M1TM_1NT3RC3PT3D}",
  "traf-04": "FLAG{DNS_TUNN3L_3XF1L_C4UGHT}",
  "ad-01": "FLAG{BL00DH0UND_P4TH_T0_D4}",
  "ad-02": "FLAG{K3RB3R04ST_SPN_CR4CK3D}",
  "ad-03": "FLAG{ASR3P_N0_PR34UTH_R04ST3D}",
  "ad-04": "FLAG{G0LD3N_T1CK3T_KRBTGT_D0M41N}",
  "wifi-01": "FLAG{WPA2_H4NDSH4K3_CR4CK3D}",
  "wifi-02": "FLAG{3V1L_TW1N_C4PT1V3_CR3DS}",
  "wifi-03": "FLAG{PMK1D_CL13NTL3SS_R04ST3D}",
  "wifi-04": "FLAG{3NT3RPR1S3_3AP_WP43_S4F3}",
  "bin-01": "FLAG{GHIDR4_R3V3RS3D_TH3_K3Y}",

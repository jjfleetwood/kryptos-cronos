...
# and essentially never "01" or "10" — the hallmark of entanglement.`,
  ...
  // ─── quantum-i10: Quantum in Your Future ─────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2024,
      overview: [
        "You have built the core intuitions: superposition, measurement, duality, interference, entanglement, qubits, and gates. This final stage zooms out to where these ideas are heading — because quantum is not a single technology but a family of them, and several are already in your life.",

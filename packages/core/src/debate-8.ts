    ...
    info: {
      ...
      technical: {
        ...
        body: [
          ...
          "Use the extensions. With two-sided messaging, rather than presenting only your side, you acknowledge the opposing argument and refute it — for an informed, skeptical audience like a judge, this is more persuasive and more durable against the opponent's later attack than a one-sided case, because it inoculates the judge and signals fairness and confidence (it also overlaps with the 'even if' weighing of epoch 4-07). With stealing thunder, you raise a genuine weakness in your own position before the opponent can, which defuses the attack (the admission is less damaging from your own mouth), builds credibility, and inoculates the judge against the opponent's framing of it. The unifying strategic insight is temporal: don't just respond to arguments after they're made — pre-empt them, building the judge's resistance before the opponent attacks. Inoculation, two-sided messaging, and stealing thunder are all ways of debating the opponent's next move before it arrives, which is among the most sophisticated psychological techniques available to an advocate.",
        ],
        codeExample: {
  ...
  // ─── debate-8-09: Confidence, Status, and Presence ────────────────────────────
  {
    ...
    info: {
      ...
      technical: {
        ...
        body: [
          "Project both warmth and competence. Competence means commanding your material, making sound arguments, staying poised, and signaling capability — necessary, but alone it can read as cold or arrogant. Warmth means civility, good faith, respect, and genuine engagement — the 'easy on the person' that builds liking and trust. Debaters who win on competence but neglect warmth forfeit persuasive power; the most credible presence visibly has both. Watch for the trap of projecting competence in a way that signals contempt (low warmth), which triggers the resistance dynamics of epoch 8-07 and the liking deficit of epoch 8-02.",
    ...
    info: {
      ...
      technical: {
        ...
        body: [
          ...
          "Build skill through deliberate practice and grit, perform through flow, and recover through resilience:\n- Deliberate practice (Ericsson) — focused, effortful practice on specific weaknesses with feedback, exactly the red-teaming (epoch 4), drilling, and ballot-reading (epoch 7-09) that build real improvement, as opposed to merely competing repeatedly without targeted work.\n- Grit (Duckworth) — sustained passion and perseverance toward the long-term goal, which often predicts achievement better than talent.\n- Flow (Csikszentmihalyi) — the absorbed, optimal-performance state when challenge meets skill, cultivated by deep preparation (raising skill) and present-focus (epoch 6-09).\n- Resilience — treat losses as information and fuel for improvement, not verdicts on your worth; the growth-mindset response to setbacks (epoch 7-05) that keeps you growing where others quit.\nThe synthesis and the close of the curriculum: mastering debate means mastering your own mind, and the mental skills it builds — growth mindset, deliberate practice, grit, flow, resilience — are the psychological foundations of achievement in any field and among the most lasting gifts the activity offers.",
        ],
        codeExample: {

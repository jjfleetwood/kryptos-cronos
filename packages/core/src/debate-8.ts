...
export const debate8Stages: StageConfig[] = [
  // ─── debate-8-01: Cognitive Biases ────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Several biases matter most in a round. Confirmation bias: people seek and weight evidence that confirms what they already believe, and discount what contradicts it — so a judge who leans one way will hear the round through that lens. Anchoring: the first number or framing encountered disproportionately shapes all subsequent judgment — which is why the opening of your case and the first framing of the round carry outsized weight. The availability heuristic: vivid, easily-recalled examples feel more probable and important than they are — which is why a concrete, memorable example can outweigh dry statistics in perceived significance. Motivated reasoning: people reason toward conclusions they want to reach, marshaling logic to defend feelings.",
      ...
      technical: {
        ...
        body: [
          "System 1 vs. System 2 (Kahneman): System 1 is fast, intuitive, and always on; System 2 is slow, effortful, and lazy — it engages only when System 1 hits something it can't handle. A judge forms a fast intuitive impression of a round (System 1) and then often rationalizes it (System 2). Implication: the felt, intuitive sense of who's winning matters enormously, so clarity, confidence, and a clean narrative that System 1 can grasp are powerful — while dense, confusing material that demands heavy System 2 effort is resisted.",
  ...
  // ─── debate-8-02: Principles of Influence ─────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1984,
      overview: [
        "In 1984, psychologist Robert Cialdini published 'Influence,' synthesizing decades of research into a set of principles by which people are reliably persuaded. Originally six, later expanded to seven, they are: reciprocity, commitment and consistency, social proof, authority, liking, scarcity, and unity. Cialdini studied these by observing the real tactics of salespeople, fundraisers, and advertisers, then testing them experimentally. For a debater, several of these principles map directly onto good debate practice — and understanding them sharpens how you deploy what you're already doing, while keeping you honest about it.",
        "The principles that matter most in a round: Authority — people defer to credible experts, which is exactly why citing qualified sources and building your own credibility (ethos, epoch 6-01) persuades; the principle also warns against the fallacy of deferring to false authority (epoch 2). Social proof — people look to what others (especially relevant others) believe, so demonstrating expert consensus ('the overwhelming majority of economists agree') is powerful, while bare appeal to popularity is a fallacy (epoch 2) — the legitimate form is consensus among the relevant knowledgeable. Consistency — people strive to act consistently with prior commitments, which is the psychological engine behind cross-examination strategy (epoch 5-04): lock the opponent into an admission, and they're pressured to stay consistent with it.",
  ...
  // ─── debate-8-03: How Judges Decide ───────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Several well-documented effects shape the judge's impression. Primacy and recency: people best remember what comes first and what comes last in a sequence, so your opening (which anchors, epoch 8-01) and your final speech (which crystallizes, epoch 5-09) carry disproportionate weight — the middle is more easily lost. Cognitive ease: information that's easy to process feels more true and more compelling (epoch 8-05), so the side that makes the round easy to follow gains an edge. The 'gestalt' of a round: judges often have a felt sense of who's winning before they've consciously tallied it, and then the line-by-line and weighing either confirm or revise that sense. The implication is not to abandon rigor but to recognize that rigor must be packaged into a clear, well-framed, easy-to-grasp whole.",
        "This reframes winning strategy around the judge's actual cognition. Front-load your strongest framing and arguments (primacy) and end with a decisive crystallization (recency) — the two positions the judge remembers best. Make the round easy to process so it feels compelling (cognitive ease). Give the judge a clean narrative and explicit weighing so the felt impression you want is the one the evidence supports — you're not manipulating, you're ensuring your genuinely winning arguments register as winning to a boundedly rational mind. And recognize that the reason for decision a judge gives is often a reconstruction of an impression formed earlier, which is why controlling the impression (through framing, clarity, and a strong open and close) is so powerful. The best debaters don't just win the argument count; they shape how the round feels to the human deciding it.",
      ],
      technical: {
  ...
  // ─── debate-8-04: Emotion and Judgment ────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1994,
      overview: [
        "The classical view, from Plato onward, cast emotion as the enemy of reason — a passion to be mastered so cold logic could rule. Modern neuroscience overturned this. In 1994, neurologist Antonio Damasio published 'Descartes' Error,' presenting evidence that emotion is not the opposite of rational decision-making but an essential part of it. His patients with damage to emotional-processing regions of the brain (notably the ventromedial prefrontal cortex) retained their intelligence and logic but became unable to make even simple decisions — they could reason endlessly about options but couldn't feel their way to a choice. Emotion, it turned out, is part of the machinery of judgment, not a corruption of it.",
        ...
        "The ethical and strategic line, established in epoch 6-01, becomes clearer with the science. Emotion that is connected to a true, warranted argument amplifies legitimate persuasion — it helps the judge feel the genuine weight of a real impact, engaging the affective system that judgment depends on. Emotion substituted for an argument (the appeal-to-emotion fallacy, epoch 2) is manipulation — it tries to bypass reasoning with feeling alone. The science doesn't dissolve this distinction; it sharpens it. Because emotion is part of judgment, you should not strip it out (a purely cold, affectless case underuses the mind you're persuading), but neither should you weaponize it dishonestly. The complete advocate connects rigorous argument to real feeling, engaging both the logical and emotional systems that, together, are how humans actually decide — which is exactly what Aristotle grasped 2,300 years ago in pairing logos with pathos.",
      ],
      technical: {
  ...
  // ─── debate-8-05: Cognitive Load and Fluency ──────────────────────────────────
  {
    ...
    info: {
      ...
      year: 1956,
      overview: [
        "In 1956, psychologist George Miller published 'The Magical Number Seven, Plus or Minus Two,' showing that human working memory — the mental workspace where we hold and manipulate information — can juggle only a small number of items at once (famously around seven 'chunks,' later estimates often lower). This is a hard constraint on every judge: they cannot hold an unlimited number of arguments, sub-points, and responses in active memory simultaneously. Cognitive load theory builds on this: when the demands of processing information exceed working-memory capacity, comprehension and retention collapse. A round that overloads the judge's working memory — too many arguments, too fast, too tangled — simply doesn't get processed, however substantive it is.",
        ...
        "Together, working-memory limits and processing fluency turn the delivery and structure skills from epochs 4 and 6 into applied cognitive science. Reduce cognitive load: chunk arguments into a small number of clear units, signpost so the judge can offload structure onto your roadmap rather than holding it in their head, avoid needless complexity and jargon, and don't exceed the number of arguments a judge can actually track. Increase fluency: clear phrasing, clean delivery, simple structure, concrete language. This isn't dumbing down — it's recognizing that an argument the judge can't hold in working memory or easily process won't register, no matter how rigorous, while the same argument made clear and fluent both registers and feels more true. The debater who manages the judge's cognitive load and maximizes fluency gives their genuine substance its best chance to land.",
      ],
      technical: {
  ...
  // ─── debate-8-06: Reading People ──────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "The legitimate, reliable reads are about engagement and comprehension, not hidden thoughts. Whether the judge is actively flowing (writing) tells you they're tracking — if they stop, you've likely lost them and should slow down and re-signpost (epoch 6-02). Visible confusion (a furrowed brow, a pen lifted and hovering) signals you should clarify. Nodding or note-taking on a point suggests it's landing. An opponent visibly flustered in cross-ex (epoch 5-04) is a real, useful signal. These reads are reliable because they track observable states of attention and processing, and they let you adapt your delivery and strategy responsively rather than blindly.",
        "The danger zone is 'mind-reading' — inferring specific hidden thoughts, deception, or how a judge will vote from subtle cues. Research is clear that people are poor lie-detectors (barely better than chance), that micro-expression 'tells' are far less reliable than popular culture suggests, and that confidently reading deep intentions from body language is mostly illusion. The traps for a debater: misreading a judge's neutral 'poker face' as disapproval and panicking; assuming a stone-faced judge dislikes your argument when they're simply concentrating; or 'reading' an opponent's confidence as a sign their argument is strong (it may be bluster, epoch 8-09). The disciplined approach: rely on the reliable, observable signals of engagement and comprehension to adapt, while staying humble about inferring hidden thoughts — and never let an overconfident misread rattle you or change a sound strategy. Read behavior for engagement; don't pretend to read minds.",
      ],
      technical: {
  ...
  // ─── debate-8-07: Why Minds Resist ────────────────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Several mechanisms drive resistance. Motivated reasoning: people reason toward conclusions they want to reach, scrutinizing unwelcome evidence harshly while waving through welcome evidence — they're not neutral judges of arguments but advocates for their existing position. Identity-protective cognition (studied by Dan Kahan): when a belief is bound up with group identity, accepting a contrary argument feels like a betrayal of one's tribe, so people defend the belief to protect their identity, and more knowledge can even deepen the divide. Belief perseverance: beliefs persist even after their original evidence is discredited. Importantly, the 'backfire effect' (the idea that correcting people makes them believe the falsehood more strongly) — once thought common — is now understood to be rarer and less robust than initially believed; corrections usually do move people somewhat, just less than we'd hope. Getting this nuance right matters: minds resist, but they're not hopeless.",
        "The practical upshot transforms how a debater approaches persuasion. Don't just be right — make it psychologically possible for the judge (or in real life, the person) to agree. Reduce identity threat: frame your argument so accepting it doesn't require the listener to repudiate their group or their self-image. Find and affirm common ground before introducing the disagreement, lowering defenses. Grant what you can (strategic concession, epoch 5-08) so the listener doesn't feel attacked and dig in. Avoid contempt, which triggers identity-protective defenses ('easy on the person,' epoch 1, is also persuasion psychology). And calibrate expectations: you're often not flipping a deep belief but moving someone incrementally, which is a real win. In a debate round, the judge is usually more neutral than a partisan in the wild, but the same dynamics apply — an argument framed to let the judge agree without feeling foolish or threatened persuades far better than one that, however correct, forces them to admit they were wrong. Persuasion is as much about removing reasons to resist as adding reasons to agree.",
      ],
      technical: {
  ...
  // ─── debate-8-08: Inoculation and Preemption ──────────────────────────────────
  {
    ...
    info: {
      ...
      overview: [
        ...
        "Inoculation works through two components: forewarning (alerting the person that a persuasive attack is coming) and refutational preemption (presenting a weakened version of the opposing argument along with a refutation). The forewarning raises the person's defenses; the refutation gives them the tools to resist. In a round, this is the technique of pre-emption: 'My opponent will argue X. Here's why that's wrong before they even say it.' When the opponent then makes argument X, the judge has already been inoculated — they've seen it coming and been given the refutation, so it lands with far less force. This is why anticipating and pre-empting the opponent's best arguments (a case-construction skill, epoch 4) is so powerful psychologically, not just tactically.",
        "Two related, research-supported techniques extend inoculation. Two-sided messaging: presenting both your side and the opposing side (then refuting it) is more persuasive and more resistant to later counter-persuasion than a one-sided message — especially for informed or skeptical audiences (a judge is exactly such an audience), because it inoculates them and signals your fairness and confidence. A purely one-sided case leaves the judge un-inoculated and vulnerable to the opponent's first good point. 'Stealing thunder': raising a weakness in your own case before the opponent does defuses it — the admission feels less damaging coming from you, and it builds credibility (and inoculates the judge against the opponent's version). These techniques share inoculation's logic: you strengthen your position not only by building your own case but by pre-emptively building the judge's resistance to what's coming. The forward-thinking debater debates the opponent's next speech before it happens.",
      ],
      technical: {
  ...
  // ─── debate-8-09: Confidence, Status, and Presence ────────────────────────────
  {
    ...
    info: {
      ...
      year: 2007,
      overview: [
        "Social psychology has found that people evaluate others along two fundamental, near-universal dimensions: warmth (are you friendly, trustworthy, well-intentioned?) and competence (are you capable, intelligent, effective?). The 'stereotype content model' (Fiske, Cuddy, and Glick, 2007) showed these two axes structure first impressions across cultures. For a debater, this maps directly onto ethos (epoch 6-01): you must project both competence (command of the material, sound arguments, poise) and warmth (civility, good faith, respect — epoch 1's 'easy on the person'). Debaters often over-index on competence and neglect warmth, coming across as capable but cold or arrogant — which undermines the liking that drives persuasion (epoch 8-02). The most persuasive presence combines both: visibly competent and genuinely warm.",
        ...
        "Two further distinctions sharpen the picture. Status is signaled in two different ways: dominance (intimidation, force, aggression) and prestige (respect freely given for competence and warmth) — and in a setting judged on merit and conduct, like debate, prestige persuades while naked dominance often repels. So you project authority through demonstrated competence and warmth, not through intimidation. And many strong debaters battle impostor feelings — the private sense of being a fraud despite real ability — which is extremely common and need not undermine performance: confidence is something you project through preparation and composure (epoch 6-09), independent of private doubt. The complete advocate cultivates a presence that is warm and competent, confident in calibration to their actual case, calm rather than loud, and built on prestige rather than dominance — projecting the steady, credible authority that the psychology of credibility shows to be most persuasive.",
      ],
      technical: {
  ...
  // ─── debate-8-10: The Debater's Mind ──────────────────────────────────────────
  {
    ...
    info: {
      ...
      year: 2006,
      overview: [
        "This epoch has examined the minds of judges and opponents; it closes with the most important mind of all — your own. How you think about your own ability, effort, and setbacks shapes everything. Psychologist Carol Dweck's research on mindset (synthesized in her 2006 book) distinguishes a fixed mindset (ability is innate and unchangeable) from a growth mindset (ability is built through effort and learning). The finding, with important nuances, is that believing skills can be developed leads people to embrace challenge, persist through difficulty, and improve, while believing ability is fixed leads them to avoid challenge and give up when they struggle. For a debater, this is foundational: debate skill is overwhelmingly built, not innate — every skill in this curriculum is learnable — and a growth mindset is what sustains the years of practice that mastery requires.",
        "Two related findings deepen the picture. Anders Ericsson's research on expertise showed that elite performance across fields comes not from raw talent but from 'deliberate practice' — focused, effortful practice targeting specific weaknesses with feedback, sustained over years (the red-teaming, drilling, and ballot-reading of earlier epochs are deliberate practice). And Angela Duckworth's work on 'grit' — passion and perseverance toward long-term goals — found that sustained effort over time often predicts achievement better than talent. Together these reframe debate ability: it is the product of growth mindset, deliberate practice, and grit far more than of innate gift. The losses, the hard rounds, the slow improvement are not signs you don't belong — they are the process by which skill is actually built, and a debater who understands this persists where others quit.",
